...
public final class Iconify {
    ...
    public enum IconValue implements BaseIconValue {
        ...
        @Override // com.joanzapata.android.iconify.BaseIconValue
        public char character() {
        ...
        public String getTtfFilename() {
            return Iconify.FONTAWESOME_TTF_FILE;
        }

        @Override // com.joanzapata.android.iconify.BaseIconValue
        public IconValue iconFrom(String str) {
            return valueOf(str);
        }
    }
    ...
    public static void addIcons(TextView... textViewArr) {
        addIcons(IconValue.fa_500px, textViewArr);
    }
    ...
    public static void setIcon(TextView textView, IconValue iconValue) {
        textView.setTypeface(getTypeface(textView.getContext(), iconValue.getTtfFilename()));
        textView.setText(String.valueOf(iconValue.character));
    }

    /* JADX WARN: Incorrect types in method signature: <T:Ljava/lang/Enum<TT;>;:Lcom/joanzapata/android/iconify/BaseIconValue;>(TT;[Landroid/widget/TextView;)V */
    public static void addIcons(Enum r5, TextView... textViewArr) {
        for (TextView textView : textViewArr) {
            textView.setTypeface(getTypeface(textView.getContext(), ((BaseIconValue) r5).getTtfFilename()));
            textView.setText(compute(r5, textView.getText()));
        }
    }

    /* JADX WARN: Incorrect types in method signature: <T:Ljava/lang/Enum<TT;>;:Lcom/joanzapata/android/iconify/BaseIconValue;>(TT;Ljava/lang/CharSequence;)Ljava/lang/CharSequence; */
    public static CharSequence compute(Enum r1, CharSequence charSequence) {
        if (charSequence instanceof Spanned) {
            return Html.fromHtml(Utils.replaceIcons(r1, new StringBuilder(Html.toHtml((Spanned) charSequence))).toString());
        }
        return Utils.replaceIcons(r1, new StringBuilder(charSequence.toString()));
    }
    ...
    public static Typeface getTypeface(Context context, String str) {
        ...
        if (typeface == null) {
            try {
                Typeface createFromFile = Typeface.createFromFile(Utils.resourceToFile(context, str));
                typefaces.put(str, createFromFile);
