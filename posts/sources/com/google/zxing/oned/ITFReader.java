...
public final class ITFReader extends OneDReader {
    ...
    /* renamed from: N */
    private static final int f3905N = 1;

    /* renamed from: W */
    private static final int f3906W = 3;
    ...
    private static int[] findGuardPattern(BitArray bitArray, int i, int[] iArr) {
        ...
        while (i < size) {
            if (bitArray.get(i) ^ z) {
                ...
                if (i3 != i4) {
                    i3++;
                } else if (OneDReader.patternMatchVariance(iArr2, iArr, MAX_INDIVIDUAL_VARIANCE) < 107) {
                    return new int[]{i2, i};
                } else {
                    i2 += iArr2[0] + iArr2[1];
                    int i5 = length - 2;
    ...
    */
    ...
    public int[] decodeEnd(BitArray bitArray) {
        bitArray.reverse();
        try {
    ...
    public int[] decodeStart(BitArray bitArray) {
