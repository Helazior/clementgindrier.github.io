    ...
    public boolean[] encode(String str) {
        ...
        if (length <= 80) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                toIntArray(Code39Reader.CHARACTER_ENCODINGS[Code39Reader.ALPHABET_STRING.indexOf(str.charAt(i2))], iArr);
            ...
            for (int i4 = length - 1; i4 >= 0; i4--) {
                toIntArray(Code39Reader.CHARACTER_ENCODINGS[Code39Reader.ALPHABET_STRING.indexOf(str.charAt(i4))], iArr);
        ...
        throw new IllegalArgumentException(outline.m273H("Requested contents should be less than 80 digits long, but got ", length));
    }
}
