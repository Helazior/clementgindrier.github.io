...
public final class GeneralAppIdDecoder {
    ...
    private DecodedChar decodeAlphanumeric(int i) {
        ...
        if (extractNumericValueFromBitArray == 15) {
            return new DecodedChar(i + 5, DecodedChar.FNC1);
        }
        ...
        switch (extractNumericValueFromBitArray2) {
            ...
            case 62:
                ...
                break;
            default:
                throw new IllegalStateException(outline.m273H("Decoding invalid alphanumeric value: ", extractNumericValueFromBitArray2));
        }
        ...
        if (extractNumericValueFromBitArray2 < 64 || extractNumericValueFromBitArray2 >= 90) {
            ...
            switch (extractNumericValueFromBitArray3) {
                ...
                case 252:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException(outline.m273H("Decoding invalid ISO/IEC 646 value: ", extractNumericValueFromBitArray3));
            }
