...
public final class Encoder {
    ...
    */
    ...
    private static int calculateMaskPenalty(ByteMatrix byteMatrix) {
        int applyMaskPenaltyRule2 = MaskUtil.applyMaskPenaltyRule2(byteMatrix) + MaskUtil.applyMaskPenaltyRule1(byteMatrix);
        return MaskUtil.applyMaskPenaltyRule4(byteMatrix) + MaskUtil.applyMaskPenaltyRule3(byteMatrix) + applyMaskPenaltyRule2;
    }
    ...
    public static void terminateBits(int i, BitArray bitArray) {
        ...
        StringBuilder m253r = outline.m253r("data bits cannot fit in the QR Code");
    ...
    public static QRCode encode(String str, ErrorCorrectionLevel errorCorrectionLevel, Map<EncodeHintType, ?> map) {
        ...
        Version chooseVersion = chooseVersion(bitArray2.getSize() + chooseMode.getCharacterCountBits(chooseVersion(bitArray2.getSize() + chooseMode.getCharacterCountBits(Version.getVersionForNumber(1)) + bitArray.getSize(), errorCorrectionLevel)) + bitArray.getSize(), errorCorrectionLevel);
