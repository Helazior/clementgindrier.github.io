...
public final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f3901FS = 28;

    /* renamed from: GS */
    private static final char f3902GS = 29;
    private static final char LATCHA = 65527;
    private static final char LATCHB = 65528;
    private static final char LOCK = 65529;

    /* renamed from: NS */
    private static final char f3903NS = 65531;
    private static final char PAD = 65532;

    /* renamed from: RS */
    private static final char f3904RS = 30;
    ...
    public static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, postCode3 + f3902GS + format + f3902GS + format2 + f3902GS);
            } else {
                sb.insert(0, postCode3 + f3902GS + format + f3902GS + format2 + f3902GS);
            }
        } else if (i == 4) {
