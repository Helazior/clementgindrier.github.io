...
public final class Detector {
    ...
    private void extractParameters(Point[] pointArr) {
        boolean[] zArr;
    ...
    private Point[] getBullEyeCornerPoints(Point point) {
        ...
        this.compact = i == 5;
        float f = 1.5f / ((i * 2) - 3);
        int x = point2.getX() - point4.getX();
        int y = point2.getY() - point4.getY();
        float f2 = x * f;
        int round = MathUtils.round(point4.getX() - f2);
        float f3 = y * f;
        int round2 = MathUtils.round(point4.getY() - f3);
        int round3 = MathUtils.round(point2.getX() + f2);
        int round4 = MathUtils.round(point2.getY() + f3);
        int x2 = point3.getX() - point5.getX();
        int y2 = point3.getY() - point5.getY();
        float f4 = x2 * f;
        int round5 = MathUtils.round(point5.getX() - f4);
        float f5 = f * y2;
        int round6 = MathUtils.round(point5.getY() - f5);
        int round7 = MathUtils.round(point3.getX() + f4);
        int round8 = MathUtils.round(point3.getY() + f5);
    ...
    private ResultPoint[] getMatrixCornerPoints(Point[] pointArr) {
        int i = this.nbLayers;
        float f = (((i - 4) / 8) + ((i * 2) + (i > 4 ? 1 : 0))) / (this.nbCenterLayers * 2.0f);
    ...
    private BitMatrix sampleGrid(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4) {
        ...
        int i4 = i2;
        float f = i4 - 0.5f;
        return GridSampler.getInstance().sampleGrid(bitMatrix, i4, i4, 0.5f, 0.5f, f, 0.5f, f, f, 0.5f, f, resultPoint.getX(), resultPoint.getY(), resultPoint4.getX(), resultPoint4.getY(), resultPoint3.getX(), resultPoint3.getY(), resultPoint2.getX(), resultPoint2.getY());
    }
