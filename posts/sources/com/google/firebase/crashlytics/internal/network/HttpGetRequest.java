...
public class HttpGetRequest {
    ...
    private String createParamsString(Map<String, String> map) {
        ...
        while (it.hasNext()) {
            ...
            m253r.append(next2.getKey());
            m253r.append("=");
            m253r.append(next2.getValue() != null ? next2.getValue() : "");
    ...
    private String createUrlWithParams(String str, Map<String, String> map) {
        ...
        if (str.contains("?")) {
            if (!str.endsWith("&")) {
                createParamsString = outline.m266e("&", createParamsString);
            }
            return outline.m266e(str, createParamsString);
        }
        return outline.m265f(str, "?", createParamsString);
    }
    ...
    public HttpResponse execute() {
        ...
        try {
            ...
            Logger.getLogger().m1078v("GET Request URL: " + createUrlWithParams);
