...
public final class AutoValue_CrashlyticsReport_Session_Event_Application_Execution extends CrashlyticsReport.Session.Event.Application.Execution {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution build() {
            ...
            if (this.exception == null) {
                str = outline.m266e(str, " exception");
            }
            if (this.signal == null) {
                str = outline.m266e(str, " signal");
            }
            if (this.binaries == null) {
                str = outline.m266e(str, " binaries");
            }
            if (str.isEmpty()) {
    ...
    public String toString() {
        StringBuilder m253r = outline.m253r("Execution{threads=");
        m253r.append(this.threads);
        m253r.append(", exception=");
        m253r.append(this.exception);
        m253r.append(", signal=");
        m253r.append(this.signal);
        m253r.append(", binaries=");
        m253r.append(this.binaries);
        m253r.append("}");
