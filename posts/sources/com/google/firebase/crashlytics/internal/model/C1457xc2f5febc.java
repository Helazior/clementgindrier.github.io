...
public final class C1457xc2f5febc extends CrashlyticsReport.Session.Event.Application.Execution.Exception {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Exception.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Exception build() {
            ...
            if (this.overflowCount == null) {
                str = outline.m266e(str, " overflowCount");
            }
            if (str.isEmpty()) {
                return new C1457xc2f5febc(this.type, this.reason, this.frames, this.causedBy, this.overflowCount.intValue());
            }
    ...
    public String toString() {
        StringBuilder m253r = outline.m253r("Exception{type=");
        m253r.append(this.type);
        m253r.append(", reason=");
        m253r.append(this.reason);
        m253r.append(", frames=");
        m253r.append(this.frames);
        m253r.append(", causedBy=");
        m253r.append(this.causedBy);
        m253r.append(", overflowCount=");
        return outline.m263h(m253r, this.overflowCount, "}");
    }

    private C1457xc2f5febc(String str, String str2, ImmutableList<CrashlyticsReport.Session.Event.Application.Execution.Thread.Frame> immutableList, CrashlyticsReport.Session.Event.Application.Execution.Exception exception, int i) {
        this.type = str;
        this.reason = str2;
        this.frames = immutableList;
        this.causedBy = exception;
