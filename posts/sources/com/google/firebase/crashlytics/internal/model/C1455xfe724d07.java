...
public final class C1455xfe724d07 extends CrashlyticsReport.Session.Event.Application.Execution.BinaryImage {
    ...
    public static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.BinaryImage.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.BinaryImage build() {
            ...
            if (this.size == null) {
                str = outline.m266e(str, " size");
            }
            if (this.name == null) {
                str = outline.m266e(str, " name");
            }
            if (str.isEmpty()) {
                return new C1455xfe724d07(this.baseAddress.longValue(), this.size.longValue(), this.name, this.uuid);
            }
    ...
    public String toString() {
        StringBuilder m253r = outline.m253r("BinaryImage{baseAddress=");
        m253r.append(this.baseAddress);
        m253r.append(", size=");
        m253r.append(this.size);
        m253r.append(", name=");
        m253r.append(this.name);
        m253r.append(", uuid=");
        return outline.m262i(m253r, this.uuid, "}");
    }

    private C1455xfe724d07(long j, long j2, String str, String str2) {
        this.baseAddress = j;
        this.size = j2;
        this.name = str;
        this.uuid = str2;
