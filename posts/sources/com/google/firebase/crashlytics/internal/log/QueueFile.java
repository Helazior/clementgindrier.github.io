...
public class QueueFile implements Closeable {
    ...
    public static class Element {
        ...
        public String toString() {
            ...
            sb.append(", length = ");
            return outline.m263h(sb, this.length, "]");
        }
    }
    ...
    private void readHeader() {
        ...
        StringBuilder m253r = outline.m253r("File is truncated. Expected length: ");
        m253r.append(this.fileLength);
        m253r.append(", Actual length: ");
        m253r.append(this.raf.length());
