...
public class MetaDataStore {
    ...
    public File getKeysFileForSession(String str) {
        return new File(this.filesDir, outline.m265f(str, KEYDATA_SUFFIX, METADATA_EXT));
    }

    public File getUserDataFileForSession(String str) {
        return new File(this.filesDir, outline.m265f(str, USERDATA_SUFFIX, METADATA_EXT));
    }
        ...
        try {
            try {
                ...
                try {
                    ...
                    Logger.getLogger().m1081e("Error deserializing user metadata.", e);
        ...
        try {
            try {
                ...
                try {
                    ...
                    Logger.getLogger().m1081e("Error serializing key/value metadata.", e);
        ...
        try {
            try {
                ...
                try {
                    ...
                    e = e;
                    bufferedWriter = bufferedWriter2;
                    Logger.getLogger().m1081e("Error serializing user metadata.", e);
