    ...
    public enum Architecture {
        ...
        public static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(str)) {
                Logger.getLogger().m1078v("Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
    ...
    */
    public static java.lang.String extractFieldFromSystemFile(java.io.File r6, java.lang.String r7) {
        ...
        L40:
            ...
            r3.m1081e(r6, r7)     // Catch: java.lang.Throwable -> L59
            goto L36
        L59:
            r6 = move-exception
            r2 = r1
                ...
                if (!TextUtils.isEmpty(extractFieldFromSystemFile)) {
                    ...
                    try {
                        if (upperCase.endsWith("KB")) {
                            ...
                            logger.m1076w("Unexpected meminfo format while computing RAM: " + upperCase);
                        }
                    } catch (NumberFormatException e) {
                        Logger logger2 = Logger.getLogger();
                        logger2.m1081e("Unexpected meminfo format while computing RAM: " + upperCase, e);
                    }
                }
                totalRamInBytes = j2;
            }
    ...
    public static String resolveUnityEditorVersion(Context context) {
        ...
        if (resourcesIdentifier != 0) {
            ...
            Logger logger = Logger.getLogger();
            logger.m1078v("Unity Editor version is: " + string);
            return string;
        }
        return null;
    }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            Logger logger = Logger.getLogger();
            logger.m1081e("Could not create hashing algorithm: " + str + ", returning empty string.", e);
            return "";
        }
    }
}
