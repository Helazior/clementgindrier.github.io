...
public final class AutoValue_InstallationTokenResult extends InstallationTokenResult {
    ...
    public static final class Builder extends InstallationTokenResult.Builder {
        ...
        public InstallationTokenResult build() {
            ...
            if (this.tokenExpirationTimestamp == null) {
                str = outline.m266e(str, " tokenExpirationTimestamp");
            }
            if (this.tokenCreationTimestamp == null) {
                str = outline.m266e(str, " tokenCreationTimestamp");
            }
            if (str.isEmpty()) {
    ...
    public String toString() {
        StringBuilder m253r = outline.m253r("InstallationTokenResult{token=");
        m253r.append(this.token);
        m253r.append(", tokenExpirationTimestamp=");
        m253r.append(this.tokenExpirationTimestamp);
        m253r.append(", tokenCreationTimestamp=");
        m253r.append(this.tokenCreationTimestamp);
        m253r.append("}");
