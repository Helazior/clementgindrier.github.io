...
public class PersistedInstallation {
    ...
    public PersistedInstallation(FirebaseApp firebaseApp) {
        ...
        StringBuilder m253r = outline.m253r("PersistedInstallation.");
        m253r.append(firebaseApp.getPersistenceKey());
        m253r.append(".json");
        this.dataFile = new File(filesDir, m253r.toString());
    ...
    public PersistedInstallationEntry readPersistedInstallationEntryValue() {
        ...
        int optInt = readJSONFromFile.optInt(PERSISTED_STATUS_KEY, 0);
