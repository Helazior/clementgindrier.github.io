...
public class FirebaseApp {
    ...
    @GuardedBy("LOCK")
    public static final Map<String, FirebaseApp> INSTANCES = new C2339x1();
    ...
    public FirebaseApp(Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.componentRuntime = ComponentRuntime.builder(UI_EXECUTOR).addLazyComponentRegistrars(ComponentDiscovery.forContext(context, ComponentDiscoveryService.class).discoverLazy()).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponent(Component.m1086of(context, Context.class, new Class[0])).addComponent(Component.m1086of(this, FirebaseApp.class, new Class[0])).addComponent(Component.m1086of(firebaseOptions, FirebaseOptions.class, new Class[0])).build();
    ...
    public void initializeAllApis() {
        if (!(Build.VERSION.SDK_INT >= 24 ? ((UserManager) this.applicationContext.getSystemService(UserManager.class)).isUserUnlocked() : true)) {
            StringBuilder m253r = outline.m253r("Device in Direct Boot Mode: postponing initialization of Firebase APIs for app ");
            m253r.append(getName());
            Log.i(LOG_TAG, m253r.toString());
            UserUnlockReceiver.ensureReceiverRegistered(this.applicationContext);
            return;
        }
        StringBuilder m253r2 = outline.m253r("Device unlocked: initializing all Firebase APIs for app ");
        m253r2.append(getName());
        Log.i(LOG_TAG, m253r2.toString());
    ...
    public String toString() {
        return Objects.toStringHelper(this).add(CrashlyticsAnalyticsListener.EVENT_NAME_KEY, this.name).add("options", this.options).toString();
    }
