...
public class MessagingAnalytics {
    ...
    public static String getInstanceId(Intent intent) {
        String stringExtra = intent.getStringExtra(Constants.MessagePayloadKeys.f3894TO);
    ...
    public static void logNotificationReceived(Intent intent) {
        ...
        if (shouldUploadFirelogAnalytics(intent)) {
            ...
            if (transportFactory != null) {
                logToFirelog(Constants.FirelogAnalytics.EventType.MESSAGE_DELIVERED, intent, transportFactory.getTransport(Constants.FirelogAnalytics.FCM_LOG_SOURCE, String.class, Encoding.m1118of("json"), MessagingAnalytics$$Lambda$0.$instance));
            } else {
