...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder(String str) {
            ...
            this.bundle = bundle;
            this.data = new C2339x1();
            if (TextUtils.isEmpty(str)) {
                String valueOf = String.valueOf(str);
                throw new IllegalArgumentException(valueOf.length() != 0 ? "Invalid to: ".concat(valueOf) : new String("Invalid to: "));
            } else {
                bundle.putString(Constants.MessagePayloadKeys.f3894TO, str);
            }
        }
    ...
    public RemoteMessage(@SafeParcelable.Param(m1097id = 2) Bundle bundle) {
        this.bundle = bundle;
    }
    ...
    public String getTo() {
        return this.bundle.getString(Constants.MessagePayloadKeys.f3894TO);
    }
