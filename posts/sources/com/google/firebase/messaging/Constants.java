...
public final class Constants {
    ...
    public static final class MessagePayloadKeys {
        ...
        /* renamed from: TO */
        public static final String f3894TO = "google.to";
        public static final String TTL = "google.ttl";

        private MessagePayloadKeys() {
        }

        public static C2339x1<String, String> extractDeveloperDefinedPayload(Bundle bundle) {
            C2339x1<String, String> c2339x1 = new C2339x1<>();
