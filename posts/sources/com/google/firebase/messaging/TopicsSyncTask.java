...
public class TopicsSyncTask implements Runnable {
    ...
    private static String createPermissionMissingLog(String str) {
        return outline.m261j(new StringBuilder(str.length() + CipherSuite.TLS_DHE_PSK_WITH_RC4_128_SHA), "Missing Permission: ", str, ". This permission should normally be included by the manifest merger, but may needed to be manually added to your manifest");
    }
