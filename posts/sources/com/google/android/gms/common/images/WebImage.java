...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getUrl", m1098id = 2)
    private final Uri zab;
    @SafeParcelable.Field(getter = "getWidth", m1098id = 3)
    private final int zac;
    @SafeParcelable.Field(getter = "getHeight", m1098id = 4)
    private final int zad;

    @SafeParcelable.Constructor
    public WebImage(@SafeParcelable.Param(m1097id = 1) int i, @SafeParcelable.Param(m1097id = 2) Uri uri, @SafeParcelable.Param(m1097id = 3) int i2, @SafeParcelable.Param(m1097id = 4) int i3) {
        this.zaa = i;
        this.zab = uri;
        this.zac = i2;
        this.zad = i3;
