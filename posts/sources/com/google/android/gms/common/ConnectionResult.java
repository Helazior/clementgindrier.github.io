...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", m1098id = 2)
    private final int zzb;
    @SafeParcelable.Field(getter = "getResolution", m1098id = 3)
    private final PendingIntent zzc;
    @SafeParcelable.Field(getter = "getErrorMessage", m1098id = 4)
    ...
    public ConnectionResult(@SafeParcelable.Param(m1097id = 1) int i, @SafeParcelable.Param(m1097id = 2) int i2, @SafeParcelable.Param(m1097id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(m1097id = 4) String str) {
        this.zza = i;
        this.zzb = i2;
