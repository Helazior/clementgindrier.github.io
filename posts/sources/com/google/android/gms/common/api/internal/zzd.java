...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    private final Map<String, LifecycleCallback> zzb = Collections.synchronizedMap(new C2339x1());
    private int zzc = 0;
    private Bundle zzd;
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        if (weakReference == null || (zzdVar = weakReference.get()) == null) {
            try {
                zzd zzdVar2 = (zzd) fragmentActivity.m1445u().mo2303d("SupportLifecycleFragmentImpl");
                if (zzdVar2 == null || zzdVar2.isRemoving()) {
                    zzdVar2 = new zzd();
                    LayoutInflater$Factory2C0236K5 layoutInflater$Factory2C0236K5 = (LayoutInflater$Factory2C0236K5) fragmentActivity.m1445u();
                    Objects.requireNonNull(layoutInflater$Factory2C0236K5);
                    C0088D5 c0088d5 = new C0088D5(layoutInflater$Factory2C0236K5);
                    c0088d5.mo2150f(0, zzdVar2, "SupportLifecycleFragmentImpl", 1);
                    c0088d5.mo2152d();
                }
    ...
    public final void addCallback(String str, LifecycleCallback lifecycleCallback) {
        ...
        throw new IllegalArgumentException(outline.m261j(new StringBuilder(String.valueOf(str).length() + 59), "LifecycleCallback with tag ", str, " already added to this fragment."));
    }
