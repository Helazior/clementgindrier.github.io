...
public abstract class GoogleApiClient {
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            this.zah = new C2339x1();
            this.zaj = new C2339x1();
            this.zal = -1;
        ...
        public GoogleApiClient build() {
            ...
            for (Api<?> api2 : this.zaj.keySet()) {
                ...
                c2339x1.put(api2, Boolean.valueOf(z2));
                ...
                c2339x12.put(api2.zab(), buildClient);
                ...
                if (buildClient.providesSignIn()) {
                    if (api != null) {
                        ...
                        String zad3 = api.zad();
                        throw new IllegalStateException(outline.m261j(new StringBuilder(String.valueOf(zad2).length() + 21 + String.valueOf(zad3).length()), zad2, " cannot be used with ", zad3));
                    }
                    api = api2;
                }
            }
            if (api != null) {
                if (!z) {
                    ...
                    String zad4 = api.zad();
                    throw new IllegalStateException(outline.m261j(new StringBuilder(String.valueOf(zad4).length() + 82), "With using ", zad4, ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            }
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, zaa, this.zao, this.zap, c2339x1, this.zaq, this.zar, c2339x12, this.zal, zabe.zad(c2339x12.values(), true), arrayList);
