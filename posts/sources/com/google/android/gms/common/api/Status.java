...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    @SafeParcelable.VersionField(m1096id = 1000)
    public final int zzb;
    @SafeParcelable.Field(getter = "getStatusCode", m1098id = 1)
    private final int zzc;
    @SafeParcelable.Field(getter = "getStatusMessage", m1098id = 2)
    private final String zzd;
    @SafeParcelable.Field(getter = "getPendingIntent", m1098id = 3)
    private final PendingIntent zze;
    @SafeParcelable.Field(getter = "getConnectionResult", m1098id = 4)
    ...
    @KeepForSdk
    public Status(@SafeParcelable.Param(m1097id = 1000) int i, @SafeParcelable.Param(m1097id = 1) int i2, @SafeParcelable.Param(m1097id = 2) String str, @SafeParcelable.Param(m1097id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(m1097id = 4) ConnectionResult connectionResult) {
        this.zzb = i;
        this.zzc = i2;
        this.zzd = str;
