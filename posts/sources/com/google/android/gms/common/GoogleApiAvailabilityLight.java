...
public class GoogleApiAvailabilityLight {
    ...
    public Intent getErrorResolutionIntent(Context context, int i, String str) {
        if (i != 1 && i != 2) {
            ...
            StringBuilder m253r = outline.m253r("gcore_");
            m253r.append(GOOGLE_PLAY_SERVICES_VERSION_CODE);
            m253r.append("-");
            ...
            if (context != null) {
                try {
                    m253r.append(Wrappers.packageManager(context).getPackageInfo(context.getPackageName(), 0).versionCode);
                } catch (PackageManager.NameNotFoundException unused) {
                }
            }
            return com.google.android.gms.common.internal.zzt.zzb("com.google.android.gms", m253r.toString());
        }
    }
