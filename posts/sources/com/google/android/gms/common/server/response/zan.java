...
public final class zan extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getRootClassName", m1098id = 3)
    private final String zac;

    @SafeParcelable.Constructor
    public zan(@SafeParcelable.Param(m1097id = 1) int i, @SafeParcelable.Param(m1097id = 2) ArrayList<zal> arrayList, @SafeParcelable.Param(m1097id = 3) String str) {
        this.zaa = i;
