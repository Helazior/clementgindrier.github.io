...
public final class AutoValue_AndroidClientInfo extends AndroidClientInfo {
    ...
    public String toString() {
        StringBuilder m253r = outline.m253r("AndroidClientInfo{sdkVersion=");
        m253r.append(this.sdkVersion);
        m253r.append(", model=");
        m253r.append(this.model);
        m253r.append(", hardware=");
        m253r.append(this.hardware);
        m253r.append(", device=");
        m253r.append(this.device);
        m253r.append(", product=");
        m253r.append(this.product);
        m253r.append(", osBuild=");
        m253r.append(this.osBuild);
        m253r.append(", manufacturer=");
        m253r.append(this.manufacturer);
        m253r.append(", fingerprint=");
        m253r.append(this.fingerprint);
        m253r.append(", locale=");
        m253r.append(this.locale);
        m253r.append(", country=");
        m253r.append(this.country);
        m253r.append(", mccMnc=");
        m253r.append(this.mccMnc);
        m253r.append(", applicationBuild=");
        return outline.m262i(m253r, this.applicationBuild, "}");
    }
