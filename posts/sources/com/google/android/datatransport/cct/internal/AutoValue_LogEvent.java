...
public final class AutoValue_LogEvent extends LogEvent {
    ...
    public static final class Builder extends LogEvent.Builder {
        ...
        public LogEvent build() {
            ...
            if (this.eventUptimeMs == null) {
                str = outline.m266e(str, " eventUptimeMs");
            }
            if (this.timezoneOffsetSeconds == null) {
                str = outline.m266e(str, " timezoneOffsetSeconds");
            }
            if (str.isEmpty()) {
    ...
    public String toString() {
        StringBuilder m253r = outline.m253r("LogEvent{eventTimeMs=");
        m253r.append(this.eventTimeMs);
        m253r.append(", eventCode=");
        m253r.append(this.eventCode);
        m253r.append(", eventUptimeMs=");
        m253r.append(this.eventUptimeMs);
        m253r.append(", sourceExtension=");
        m253r.append(Arrays.toString(this.sourceExtension));
        m253r.append(", sourceExtensionJsonProto3=");
        m253r.append(this.sourceExtensionJsonProto3);
        m253r.append(", timezoneOffsetSeconds=");
        m253r.append(this.timezoneOffsetSeconds);
        m253r.append(", networkConnectionInfo=");
        m253r.append(this.networkConnectionInfo);
        m253r.append("}");
