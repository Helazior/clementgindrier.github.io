...
public final class CCTDestination implements EncodedDestination {
    ...
    static {
        ...
        SUPPORTED_ENCODINGS = Collections.unmodifiableSet(new HashSet(Arrays.asList(Encoding.m1118of("proto"), Encoding.m1118of("json"))));
    ...
    public static String decodeExtras(byte[] bArr) {
