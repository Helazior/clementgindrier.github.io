...
public class BottomNavigationMenuView extends ViewGroup implements InterfaceC2186q0 {
    ...
    private final InterfaceC0037B4<BottomNavigationItemView> itemPool;
    ...
    public void buildMenuView() {
        ...
        for (int i = 0; i < this.menu.size(); i++) {
            ...
            C1950l0 c1950l0 = (C1950l0) this.menu.getItem(i);
            newItem.initialize(c1950l0, 0);
    ...
    public ColorStateList createDefaultColorStateList(int i) {
        ...
        if (getContext().getTheme().resolveAttribute(i, typedValue, true)) {
            ColorStateList m2211a = C0279M.m2211a(getContext(), typedValue.resourceId);
            if (getContext().getTheme().resolveAttribute(C1671f.colorPrimary, typedValue, true)) {
                int i2 = typedValue.data;
                int defaultColor = m2211a.getDefaultColor();
                int[] iArr = DISABLED_STATE_SET;
                return new ColorStateList(new int[][]{iArr, CHECKED_STATE_SET, ViewGroup.EMPTY_STATE_SET}, new int[]{m2211a.getColorForState(iArr, defaultColor), i2, defaultColor});
            }
            return null;
        }
        return null;
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) C1617d5.C1619b.m1013a(1, this.menu.getVisibleItems().size(), false, 1).f4004a);
    }
    ...
    public void setItemOnTouchListener(int i, View.OnTouchListener onTouchListener) {
        ...
        if (bottomNavigationItemViewArr != null) {
            for (BottomNavigationItemView bottomNavigationItemView : bottomNavigationItemViewArr) {
                if (bottomNavigationItemView.getItemData().f5411a == i) {
    ...
    public void updateMenuView() {
        C1905j0 c1905j0 = this.menu;
        if (c1905j0 == null || this.buttons == null) {
            return;
        }
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            this.buttons[i3].initialize((C1950l0) this.menu.getItem(i3), 0);
            this.presenter.setUpdateSuspended(false);
        }
    }
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.itemPool = new C0087D4(5);
        this.onTouchListeners = new SparseArray<>(5);
        this.selectedItemId = 0;
        this.selectedItemPosition = 0;
        this.badgeDrawables = new SparseArray<>(5);
        Resources resources = getResources();
        this.inactiveItemMaxWidth = resources.getDimensionPixelSize(C1103R.dimen.design_bottom_navigation_item_max_width);
        this.inactiveItemMinWidth = resources.getDimensionPixelSize(C1103R.dimen.design_bottom_navigation_item_min_width);
        this.activeItemMaxWidth = resources.getDimensionPixelSize(C1103R.dimen.design_bottom_navigation_active_item_max_width);
        this.activeItemMinWidth = resources.getDimensionPixelSize(C1103R.dimen.design_bottom_navigation_active_item_min_width);
        this.itemHeight = resources.getDimensionPixelSize(C1103R.dimen.design_bottom_navigation_height);
        this.itemTextColorDefault = createDefaultColorStateList(16842808);
        AutoTransition autoTransition = new AutoTransition();
        this.set = autoTransition;
        autoTransition.m1263e(0);
        autoTransition.m1265c(ACTIVE_ANIMATION_DURATION_MS);
        autoTransition.setInterpolator(new C1621d6());
        autoTransition.m1267a(new TextScale());
        this.onClickListener = new View.OnClickListener() { // from class: com.google.android.material.bottomnavigation.BottomNavigationMenuView.1
            ...
            public void onClick(View view) {
                C1950l0 itemData = ((BottomNavigationItemView) view).getItemData();
