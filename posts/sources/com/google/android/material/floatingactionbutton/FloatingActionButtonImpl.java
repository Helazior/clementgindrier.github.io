...
public class FloatingActionButtonImpl {
    ...
    private MotionSpec getDefaultHideMotionSpec() {
        if (this.defaultHideMotionSpec == null) {
            this.defaultHideMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C1103R.animator.design_fab_hide_motion_spec);
        }
    ...
    private MotionSpec getDefaultShowMotionSpec() {
        if (this.defaultShowMotionSpec == null) {
            this.defaultShowMotionSpec = MotionSpec.createFromResource(this.view.getContext(), C1103R.animator.design_fab_show_motion_spec);
        }
    ...
    private boolean shouldAnimateVisibilityChange() {
        ...
        return C0492V4.C0498f.m1908c(floatingActionButton) && !this.view.isInEditMode();
    }
    ...
    public void onPaddingUpdated(Rect rect) {
        LayoutInflater$Factory2C0000A.C0010h.m2637h(this.contentBackground, "Didn't initialize content background");
        if (shouldAddPadding()) {
