...
public class TabLayout extends HorizontalScrollView {
    ...
    private AbstractC1960l8 pagerAdapter;
    ...
    private final InterfaceC0037B4<TabView> tabViewPool;
    private final ArrayList<Tab> tabs;
    public boolean unboundedRipple;
    public ViewPager viewPager;
    private static final int DEF_STYLE_RES = C1103R.C1107style.Widget_Design_TabLayout;
    private static final InterfaceC0037B4<Tab> tabPool = new C0087D4(16);

    /* loaded from: /home/clement/Documents/site/ma_vie/content/posts/vulnerabilite-izly/resources/classes.dex */
    public class AdapterChangeListener implements ViewPager.InterfaceC0930h {
        ...
        public void onAdapterChanged(ViewPager viewPager, AbstractC1960l8 abstractC1960l8, AbstractC1960l8 abstractC1960l82) {
            ...
            if (tabLayout.viewPager == viewPager) {
                tabLayout.setPagerAdapter(abstractC1960l82, this.autoRefresh);
            }
        }
        ...
        public void draw(Canvas canvas) {
            ...
            if (TabLayout.this.tabSelectedIndicator.getBounds().width() > 0) {
                ...
                if (tabLayout.tabSelectedIndicatorColor != 0) {
                    drawable = LayoutInflater$Factory2C0000A.C0010h.m2604x0(drawable);
    ...
    /* loaded from: /home/clement/Documents/site/ma_vie/content/posts/vulnerabilite-izly/resources/classes.dex */
    public static class TabLayoutOnPageChangeListener implements ViewPager.InterfaceC0931i {
    ...
    public final class TabView extends LinearLayout {
        ...
        public TabView(Context context) {
            ...
            AtomicInteger atomicInteger = C0492V4.f1798a;
            C0492V4.C0496d.m1914k(this, i, i2, i3, i4);
            setGravity(17);
        ...
        private void inflateAndAddDefaultIconView() {
            ...
            ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C1103R.layout.design_layout_tab_icon, (ViewGroup) frameLayout, false);
        ...
        private void inflateAndAddDefaultTextView() {
            ...
            TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C1103R.layout.design_layout_tab_text, (ViewGroup) frameLayout, false);
        ...
        public void updateBackgroundDrawable(Context context) {
            ...
            if (i != 0) {
                Drawable m2210b = C0279M.m2210b(context, i);
                this.baseBackgroundDrawable = m2210b;
                if (m2210b != null && m2210b.isStateful()) {
            ...
            AtomicInteger atomicInteger = C0492V4.f1798a;
            C0492V4.C0495c.m1927q(this, gradientDrawable);
            TabLayout.this.invalidate();
        }

        private void updateTextAndIcon(TextView textView, ImageView imageView) {
            Tab tab = this.tab;
            Drawable mutate = (tab == null || tab.getIcon() == null) ? null : LayoutInflater$Factory2C0000A.C0010h.m2604x0(this.tab.getIcon()).mutate();
            Tab tab2 = this.tab;
            ...
            LayoutInflater$Factory2C0000A.C0010h.m2616r0(this, text);
        }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            accessibilityNodeInfo.setCollectionItemInfo((AccessibilityNodeInfo.CollectionItemInfo) C1617d5.C1620c.m1012a(0, 1, this.tab.getPosition(), 1, false, isSelected()).f4005a);
            if (isSelected()) {
        ...
        public final void update() {
            ...
            if (this.customView == null) {
                ...
                if (tab != null && tab.getIcon() != null) {
                    drawable = LayoutInflater$Factory2C0000A.C0010h.m2604x0(tab.getIcon()).mutate();
                }
                if (drawable != null) {
                ...
                LayoutInflater$Factory2C0000A.C0010h.m2624n0(this.textView, TabLayout.this.tabTextAppearance);
    ...
    private void animateToTab(int i) {
        ...
        if (getWindowToken() != null) {
            AtomicInteger atomicInteger = C0492V4.f1798a;
            if (C0492V4.C0498f.m1908c(this) && !this.slidingTabIndicator.childrenNeedLayout()) {
    ...
    private void applyModeAndGravity() {
        ...
        AtomicInteger atomicInteger = C0492V4.f1798a;
        C0492V4.C0496d.m1914k(slidingTabIndicator, max, 0, 0, 0);
        int i2 = this.mode;
        if (i2 == 0) {
    ...
    private int calculateScrollXForTab(int i, float f) {
        ...
        if (i2 == 0 || i2 == 2) {
            ...
            AtomicInteger atomicInteger = C0492V4.f1798a;
            return C0492V4.C0496d.m1921d(this) == 0 ? left + i4 : left - i4;
        }
        return 0;
    }
    ...
    private TabView createTabView(Tab tab) {
        InterfaceC0037B4<TabView> interfaceC0037B4 = this.tabViewPool;
        TabView acquire = interfaceC0037B4 != null ? interfaceC0037B4.acquire() : null;
        if (acquire == null) {
    ...
    public Tab newTab() {
        ...
        if (createTabFromPool.f3874id != -1) {
            createTabFromPool.view.setId(createTabFromPool.f3874id);
        }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        super.onInitializeAccessibilityNodeInfo(accessibilityNodeInfo);
        accessibilityNodeInfo.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) C1617d5.C1619b.m1013a(1, getTabCount(), false, 1).f4004a);
    }
    ...
    */
    ...
    public void populateFromPagerAdapter() {
        int i;
        removeAllTabs();
        AbstractC1960l8 abstractC1960l8 = this.pagerAdapter;
        if (abstractC1960l8 != null) {
            int m611b = abstractC1960l8.m611b();
            for (int i2 = 0; i2 < m611b; i2++) {
                Tab newTab = newTab();
                Objects.requireNonNull(this.pagerAdapter);
                addTab(newTab.setText((CharSequence) null), false);
            }
            ViewPager viewPager = this.viewPager;
            if (viewPager == null || m611b <= 0 || (i = viewPager.f3571g) == getSelectedTabPosition() || i >= getTabCount()) {
                return;
            }
    ...
    public void setPagerAdapter(AbstractC1960l8 abstractC1960l8, boolean z) {
        DataSetObserver dataSetObserver;
        AbstractC1960l8 abstractC1960l82 = this.pagerAdapter;
        if (abstractC1960l82 != null && (dataSetObserver = this.pagerAdapterObserver) != null) {
            abstractC1960l82.f5460a.unregisterObserver(dataSetObserver);
        }
        this.pagerAdapter = abstractC1960l8;
        if (z && abstractC1960l8 != null) {
            if (this.pagerAdapterObserver == null) {
                this.pagerAdapterObserver = new PagerAdapterObserver();
            }
            abstractC1960l8.f5460a.registerObserver(this.pagerAdapterObserver);
        }
    ...
    public void setSelectedTabIndicatorGravity(int i) {
        if (this.tabIndicatorGravity != i) {
            ...
            SlidingTabIndicator slidingTabIndicator = this.slidingTabIndicator;
            AtomicInteger atomicInteger = C0492V4.f1798a;
            C0492V4.C0495c.m1933k(slidingTabIndicator);
        }
    }
    ...
    public void setTabIconTintResource(int i) {
        setTabIconTint(C0279M.m2211a(getContext(), i));
    }
    ...
    public void setTabRippleColorResource(int i) {
        setTabRippleColor(C0279M.m2211a(getContext(), i));
    }
    ...
    @Deprecated
    public void setTabsFromPagerAdapter(AbstractC1960l8 abstractC1960l8) {
        setPagerAdapter(abstractC1960l8, false);
    }
    ...
    public static class Tab {
        ...
        public Tab setIcon(int i) {
            TabLayout tabLayout = this.parent;
            if (tabLayout != null) {
                return setIcon(C0279M.m2210b(tabLayout.getContext(), i));
            }
            throw new IllegalArgumentException("Tab not attached to a TabLayout");
        }
    }
    ...
    public TabLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1103R.attr.tabStyle);
    }
    ...
    */
    ...
    private void setupWithViewPager(ViewPager viewPager, boolean z, boolean z2) {
        List<ViewPager.InterfaceC0930h> list;
        List<ViewPager.InterfaceC0931i> list2;
        ViewPager viewPager2 = this.viewPager;
        if (viewPager2 != null) {
            TabLayoutOnPageChangeListener tabLayoutOnPageChangeListener = this.pageChangeListener;
            if (tabLayoutOnPageChangeListener != null && (list2 = viewPager2.f3556S) != null) {
                list2.remove(tabLayoutOnPageChangeListener);
            }
            AdapterChangeListener adapterChangeListener = this.adapterChangeListener;
            if (adapterChangeListener != null && (list = this.viewPager.f3559V) != null) {
        ...
        if (viewPager != null) {
            ...
            if (viewPager.f3556S == null) {
                viewPager.f3556S = new ArrayList();
            }
            viewPager.f3556S.add(tabLayoutOnPageChangeListener2);
            ViewPagerOnTabSelectedListener viewPagerOnTabSelectedListener = new ViewPagerOnTabSelectedListener(viewPager);
            this.currentVpSelectedListener = viewPagerOnTabSelectedListener;
            addOnTabSelectedListener((BaseOnTabSelectedListener) viewPagerOnTabSelectedListener);
            AbstractC1960l8 abstractC1960l8 = viewPager.f3570f;
            if (abstractC1960l8 != null) {
                setPagerAdapter(abstractC1960l8, z);
            }
            ...
            viewPager.f3559V.add(adapterChangeListener2);
            setScrollPosition(viewPager.f3571g, 0.0f, true);
        } else {
            this.viewPager = null;
    ...
    public void setSelectedTabIndicator(int i) {
        if (i != 0) {
            setSelectedTabIndicator(C0279M.m2210b(getContext(), i));
        } else {
