...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public RangeSlider(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1103R.styleable.RangeSlider, i, BaseSlider.DEF_STYLE_RES, new int[0]);
        int i2 = C1103R.styleable.RangeSlider_values;
        ...
        this.minSeparation = obtainStyledAttributes.getDimension(C1103R.styleable.RangeSlider_minSeparation, 0.0f);
