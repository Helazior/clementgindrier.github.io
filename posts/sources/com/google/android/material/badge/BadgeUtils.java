        ...
        toolbar.post(new Runnable() { // from class: com.google.android.material.badge.BadgeUtils.1
            ...
            public void run() {
                ...
                if (actionMenuItemView != null) {
                    ...
                    badgeDrawable2.setHorizontalOffset(Toolbar.this.getResources().getDimensionPixelOffset(C1103R.dimen.mtrl_badge_toolbar_action_menu_item_horizontal_offset) + badgeDrawable2.getHorizontalOffset());
                    BadgeDrawable badgeDrawable3 = badgeDrawable;
                    badgeDrawable3.setVerticalOffset(Toolbar.this.getResources().getDimensionPixelOffset(C1103R.dimen.mtrl_badge_toolbar_action_menu_item_vertical_offset) + badgeDrawable3.getVerticalOffset());
