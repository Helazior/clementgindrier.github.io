...
public class ShapePath {
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        @Override // com.google.android.material.shape.ShapePath.ShadowCompatOperation
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f3873y - this.startY, this.operation.f3872x - this.startX), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f3873y - this.startY) / (this.operation.f3872x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f3872x, this.f3873y);
            path.transform(matrix);
        }
    }
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f3872x = f;
        pathLineOperation.f3873y = f2;
