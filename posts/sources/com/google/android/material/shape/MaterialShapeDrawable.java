...
public class MaterialShapeDrawable extends Drawable implements InterfaceC0395R3, Shapeable {
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float f) {
        int color = MaterialColors.getColor(context, C1103R.attr.colorSurface, MaterialShapeDrawable.class.getSimpleName());
