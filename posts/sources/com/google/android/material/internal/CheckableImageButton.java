...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    public CheckableImageButton(Context context, AttributeSet attributeSet, int i) {
        ...
        this.checkable = true;
        this.pressable = true;
        C0492V4.m1950u(this, new C0130F4() { // from class: com.google.android.material.internal.CheckableImageButton.1
            ...
            public void onInitializeAccessibilityNodeInfo(View view, C1617d5 c1617d5) {
                ...
                c1617d5.f3986a.setCheckable(CheckableImageButton.this.isCheckable());
                c1617d5.f3986a.setChecked(CheckableImageButton.this.isChecked());
            }
        });
    }
}
