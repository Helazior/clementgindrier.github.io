...
public class FlowLayout extends ViewGroup {
    ...
    private void loadFromAttributes(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C1103R.styleable.FlowLayout, 0, 0);
        this.lineSpacing = obtainStyledAttributes.getDimensionPixelSize(C1103R.styleable.FlowLayout_lineSpacing, 0);
        this.itemSpacing = obtainStyledAttributes.getDimensionPixelSize(C1103R.styleable.FlowLayout_itemSpacing, 0);
    ...
    public int getRowIndex(View view) {
        Object tag = view.getTag(C1103R.C1106id.row_index_key);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        boolean z2 = C0492V4.C0496d.m1921d(this) == 1;
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() == 8) {
                childAt.setTag(C1103R.C1106id.row_index_key, -1);
            } else {
                ...
                childAt.setTag(C1103R.C1106id.row_index_key, Integer.valueOf(this.rowCount - 1));
                int i11 = i8 + i6;
