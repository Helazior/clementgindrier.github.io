...
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    public final boolean fling(CoordinatorLayout coordinatorLayout, V v, int i, int i2, float f) {
        ...
        if (this.scroller.computeScrollOffset()) {
            ...
            AtomicInteger atomicInteger = C0492V4.f1798a;
            C0492V4.C0495c.m1931m(v, flingRunnable);
            return true;
        }
    ...
    */
    ...
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, V v, int i, int i2, int i3) {
        ...
        if (i2 == 0 || topAndBottomOffset < i2 || topAndBottomOffset > i3 || topAndBottomOffset == (m2631k = LayoutInflater$Factory2C0000A.C0010h.m2631k(i, i2, i3))) {
            return 0;
        }
        setTopAndBottomOffset(m2631k);
        return topAndBottomOffset - m2631k;
    }
