...
public class FadeModeEvaluators {
    ...
    /* renamed from: IN */
    private static final FadeModeEvaluator f3875IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.FadeModeEvaluators.1
    ...
    public static FadeModeEvaluator get(int i, boolean z) {
        if (i == 0) {
            return z ? f3875IN : OUT;
        } else if (i == 1) {
            return z ? OUT : f3875IN;
        } else if (i != 2) {
            if (i == 3) {
                return THROUGH;
            }
