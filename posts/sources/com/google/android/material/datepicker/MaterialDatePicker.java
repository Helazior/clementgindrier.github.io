...
public final class MaterialDatePicker<S> extends DialogInterface$OnCancelListenerC0110E5 {
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, C0279M.m2210b(context, C1103R.C1105drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], C0279M.m2210b(context, C1103R.C1105drawable.material_ic_edit_black_24dp));
        return stateListDrawable;
    }

    private static int getDialogPickerHeight(Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C1103R.dimen.mtrl_calendar_navigation_bottom_padding) + resources.getDimensionPixelOffset(C1103R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelSize(C1103R.dimen.mtrl_calendar_navigation_height);
        int dimensionPixelSize = resources.getDimensionPixelSize(C1103R.dimen.mtrl_calendar_days_of_week_height);
        int i = MonthAdapter.MAXIMUM_WEEKS;
        return outline.m269b(dimensionPixelOffset, dimensionPixelSize, (resources.getDimensionPixelOffset(C1103R.dimen.mtrl_calendar_month_vertical_padding) * (i - 1)) + (resources.getDimensionPixelSize(C1103R.dimen.mtrl_calendar_day_height) * i), resources.getDimensionPixelOffset(C1103R.dimen.mtrl_calendar_bottom_padding));
    }

    private static int getPaddedPickerWidth(Context context) {
        Resources resources = context.getResources();
        int dimensionPixelOffset = resources.getDimensionPixelOffset(C1103R.dimen.mtrl_calendar_content_padding);
        int i = Month.current().daysInWeek;
        int dimensionPixelSize = resources.getDimensionPixelSize(C1103R.dimen.mtrl_calendar_day_width) * i;
        return ((i - 1) * resources.getDimensionPixelOffset(C1103R.dimen.mtrl_calendar_month_horizontal_padding)) + dimensionPixelSize + (dimensionPixelOffset * 2);
    }
    ...
    private void initHeaderToggle(Context context) {
        ...
        C0492V4.m1950u(this.headerToggleButton, null);
    ...
    public static boolean isNestedScrollable(Context context) {
        return readMaterialCalendarStyleBoolean(context, C1103R.attr.nestedScrollable);
    }
    ...
    public static boolean readMaterialCalendarStyleBoolean(Context context, int i) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, C1103R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i});
    ...
    public void startPickerFragment() {
        ...
        updateHeader();
        AbstractC0352P5 mo2309a = getChildFragmentManager().mo2309a();
        int i = C1103R.C1106id.mtrl_calendar_frame;
        PickerFragment<S> pickerFragment = this.pickerFragment;
        Objects.requireNonNull(mo2309a);
        if (i != 0) {
            mo2309a.mo2150f(i, pickerFragment, null, 2);
            mo2309a.mo2151e();
    ...
    public void updateHeader() {
        ...
        this.headerSelectionText.setContentDescription(String.format(getString(C1103R.string.mtrl_picker_announce_current_selection), headerText));
    ...
    public void updateToggleContentDescription(CheckableImageButton checkableImageButton) {
        ...
        if (this.headerToggleButton.isChecked()) {
            string = checkableImageButton.getContext().getString(C1103R.string.mtrl_picker_toggle_to_calendar_input_mode);
        } else {
            string = checkableImageButton.getContext().getString(C1103R.string.mtrl_picker_toggle_to_text_input_mode);
        }
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(context, C1103R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, C1103R.attr.materialCalendarStyle, C1103R.C1107style.Widget_MaterialComponents_MaterialCalendar);
        ...
        materialShapeDrawable2.setElevation(C0492V4.C0500h.m1892i(decorView));
        return dialog;
    }

    @Override // androidx.fragment.app.Fragment
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(this.fullscreen ? C1103R.layout.mtrl_picker_fullscreen : C1103R.layout.mtrl_picker_dialog, viewGroup);
        Context context = inflate.getContext();
        if (this.fullscreen) {
            inflate.findViewById(C1103R.C1106id.mtrl_calendar_frame).setLayoutParams(new LinearLayout.LayoutParams(getPaddedPickerWidth(context), -2));
        } else {
            View findViewById = inflate.findViewById(C1103R.C1106id.mtrl_calendar_main_pane);
            View findViewById2 = inflate.findViewById(C1103R.C1106id.mtrl_calendar_frame);
        ...
        TextView textView = (TextView) inflate.findViewById(C1103R.C1106id.mtrl_picker_header_selection_text);
        this.headerSelectionText = textView;
        AtomicInteger atomicInteger = C0492V4.f1798a;
        C0492V4.C0498f.m1905f(textView, 1);
        this.headerToggleButton = (CheckableImageButton) inflate.findViewById(C1103R.C1106id.mtrl_picker_header_toggle);
        TextView textView2 = (TextView) inflate.findViewById(C1103R.C1106id.mtrl_picker_title_text);
        ...
        this.confirmButton = (Button) inflate.findViewById(C1103R.C1106id.confirm_button);
        ...
        Button button = (Button) inflate.findViewById(C1103R.C1106id.cancel_button);
    ...
    public void onStart() {
        ...
        if (this.fullscreen) {
            ...
            int dimensionPixelOffset = getResources().getDimensionPixelOffset(C1103R.dimen.mtrl_calendar_dialog_background_inset);
    ...
    public static final class Builder<S> {
        ...
        public static Builder<C0018A4<Long, Long>> dateRangePicker() {
