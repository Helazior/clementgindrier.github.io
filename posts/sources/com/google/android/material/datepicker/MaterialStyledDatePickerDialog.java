...
public class MaterialStyledDatePickerDialog extends DatePickerDialog {
    ...
    private static final int DEF_STYLE_RES = C1103R.C1107style.MaterialAlertDialog_MaterialComponents_Picker_Date_Spinner;
    ...
    public MaterialStyledDatePickerDialog(Context context, int i, DatePickerDialog.OnDateSetListener onDateSetListener, int i2, int i3, int i4) {
        ...
        int resolveOrThrow = MaterialAttributes.resolveOrThrow(getContext(), C1103R.attr.colorSurface, getClass().getCanonicalName());
