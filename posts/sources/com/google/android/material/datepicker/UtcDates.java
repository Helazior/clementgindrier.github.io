...
public class UtcDates {
    ...
    public static String getTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        return localizedPattern.replaceAll(GoogleApiAvailabilityLight.TRACKING_SOURCE_DIALOG, resources.getString(C1103R.string.mtrl_picker_text_input_day_abbr)).replaceAll("M", resources.getString(C1103R.string.mtrl_picker_text_input_month_abbr)).replaceAll("y", resources.getString(C1103R.string.mtrl_picker_text_input_year_abbr));
    }
