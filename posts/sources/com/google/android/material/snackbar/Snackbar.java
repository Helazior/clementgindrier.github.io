...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    static {
        int i = C1103R.attr.snackbarButtonStyle;
        SNACKBAR_BUTTON_STYLE_ATTR = new int[]{i};
        SNACKBAR_CONTENT_STYLE_ATTRS = new int[]{i, C1103R.attr.snackbarTextViewStyle};
    }
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence charSequence, int i) {
        ...
        if (findSuitableParent != null) {
            ...
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(context).inflate(hasSnackbarContentStyleAttrs(context) ? C1103R.layout.mtrl_layout_snackbar_include : C1103R.layout.design_layout_snackbar_include, findSuitableParent, false);
