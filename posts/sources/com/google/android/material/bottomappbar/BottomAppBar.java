...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.InterfaceC0723b {
    private static final long ANIMATION_DURATION = 300;
    private static final int DEF_STYLE_RES = C1103R.C1107style.Widget_MaterialComponents_BottomAppBar;
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
                ...
                public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                    ...
                    if (bottomAppBar != null && (view instanceof FloatingActionButton)) {
                        ...
                        if (Behavior.this.originalBottomMargin == 0) {
                            ((ViewGroup.MarginLayoutParams) c0726e).bottomMargin = bottomAppBar.getBottomInset() + (bottomAppBar.getResources().getDimensionPixelOffset(C1103R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((floatingActionButton.getMeasuredHeight() - height) / 2));
                            ((ViewGroup.MarginLayoutParams) c0726e).leftMargin = bottomAppBar.getLeftInset();
                            ((ViewGroup.MarginLayoutParams) c0726e).rightMargin = bottomAppBar.getRightInset();
                            if (ViewUtils.isLayoutRtl(floatingActionButton)) {
                                ((ViewGroup.MarginLayoutParams) c0726e).leftMargin = bottomAppBar.fabOffsetEndMode + ((ViewGroup.MarginLayoutParams) c0726e).leftMargin;
                                return;
                            }
                            ((ViewGroup.MarginLayoutParams) c0726e).rightMargin = bottomAppBar.fabOffsetEndMode + ((ViewGroup.MarginLayoutParams) c0726e).rightMargin;
                            return;
                        }
                        return;
                    }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, BottomAppBar bottomAppBar, int i) {
            ...
            if (findDependentView != null) {
                ...
                if (!C0492V4.C0498f.m1908c(findDependentView)) {
                    CoordinatorLayout.C0726e c0726e = (CoordinatorLayout.C0726e) findDependentView.getLayoutParams();
                    c0726e.f2938d = 49;
                    this.originalBottomMargin = ((ViewGroup.MarginLayoutParams) c0726e).bottomMargin;
    ...
    */
    ...
    public int getActionMenuViewTranslationX(ActionMenuView actionMenuView, int i, boolean z) {
        if (i == 1 && z) {
            ...
            for (int i2 = 0; i2 < getChildCount(); i2++) {
                ...
                if ((childAt.getLayoutParams() instanceof Toolbar.LayoutParams) && (((Toolbar.LayoutParams) childAt.getLayoutParams()).f2214a & 8388615) == 8388611) {
                    if (isLayoutRtl) {
    ...
    public BottomAppBar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1103R.attr.bottomAppBarStyle);
    }
    ...
    */
    public BottomAppBar(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        /*
            ...
            int[] r2 = com.google.android.material.C1103R.styleable.BottomAppBar
            int[] r5 = new int[r7]
            r0 = r8
            r1 = r12
            r3 = r13
            ...
            int r1 = com.google.android.material.C1103R.styleable.BottomAppBar_backgroundTint
            android.content.res.ColorStateList r1 = com.google.android.material.resources.MaterialResources.getColorStateList(r8, r0, r1)
            int r2 = com.google.android.material.C1103R.styleable.BottomAppBar_elevation
            int r2 = r0.getDimensionPixelSize(r2, r7)
            int r3 = com.google.android.material.C1103R.styleable.BottomAppBar_fabCradleMargin
            int r3 = r0.getDimensionPixelOffset(r3, r7)
            float r3 = (float) r3
            int r4 = com.google.android.material.C1103R.styleable.BottomAppBar_fabCradleRoundedCornerRadius
            int r4 = r0.getDimensionPixelOffset(r4, r7)
            float r4 = (float) r4
            int r5 = com.google.android.material.C1103R.styleable.BottomAppBar_fabCradleVerticalOffset
            int r5 = r0.getDimensionPixelOffset(r5, r7)
            float r5 = (float) r5
            int r9 = com.google.android.material.C1103R.styleable.BottomAppBar_fabAlignmentMode
            int r9 = r0.getInt(r9, r7)
            r10.fabAlignmentMode = r9
            int r9 = com.google.android.material.C1103R.styleable.BottomAppBar_fabAnimationMode
            int r9 = r0.getInt(r9, r7)
            r10.fabAnimationMode = r9
            int r9 = com.google.android.material.C1103R.styleable.BottomAppBar_hideOnScroll
            boolean r9 = r0.getBoolean(r9, r7)
            r10.hideOnScroll = r9
            int r9 = com.google.android.material.C1103R.styleable.BottomAppBar_paddingBottomSystemWindowInsets
            boolean r9 = r0.getBoolean(r9, r7)
            r10.paddingBottomSystemWindowInsets = r9
            int r9 = com.google.android.material.C1103R.styleable.BottomAppBar_paddingLeftSystemWindowInsets
            boolean r9 = r0.getBoolean(r9, r7)
            r10.paddingLeftSystemWindowInsets = r9
            int r9 = com.google.android.material.C1103R.styleable.BottomAppBar_paddingRightSystemWindowInsets
            boolean r7 = r0.getBoolean(r9, r7)
            r10.paddingRightSystemWindowInsets = r7
            r0.recycle()
            android.content.res.Resources r0 = r10.getResources()
            int r7 = com.google.android.material.C1103R.dimen.mtrl_bottomappbar_fabOffsetEndMode
            ...
            p000.C0492V4.C0495c.m1927q(r10, r11)
