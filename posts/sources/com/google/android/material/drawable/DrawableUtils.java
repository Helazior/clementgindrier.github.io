...
public final class DrawableUtils {
    ...
    public static AttributeSet parseDrawableXml(Context context, int i, CharSequence charSequence) {
        ...
        try {
            ...
            StringBuilder m253r = outline.m253r("Can't load badge resource ID #0x");
            m253r.append(Integer.toHexString(i));
            Resources.NotFoundException notFoundException = new Resources.NotFoundException(m253r.toString());
