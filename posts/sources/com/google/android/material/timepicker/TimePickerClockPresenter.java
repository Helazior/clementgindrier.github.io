...
public class TimePickerClockPresenter implements ClockHandView.OnRotateListener, TimePickerView.OnSelectionChange, TimePickerView.OnPeriodChangeListener, ClockHandView.OnActionUpListener, TimePickerPresenter {
    ...
    public void onActionUp(float f, boolean z) {
        ...
        if (timeModel.selection == 10) {
            ...
            if (!((AccessibilityManager) C2307w3.m209c(this.timePickerView.getContext(), AccessibilityManager.class)).isTouchExplorationEnabled()) {
    ...
    public void setSelection(int i, boolean z) {
        ...
        this.timePickerView.setValues(z2 ? MINUTE_CLOCK_VALUES : getHourClockValues(), z2 ? C1103R.string.material_minute_suffix : C1103R.string.material_hour_suffix);
        this.timePickerView.setHandRotation(z2 ? this.minuteRotation : this.hourRotation, z);
        this.timePickerView.setActiveSelection(i);
        this.timePickerView.setMinuteHourDelegate(new ClickActionDelegate(this.timePickerView.getContext(), C1103R.string.material_hour_selection));
        this.timePickerView.setHourClickDelegate(new ClickActionDelegate(this.timePickerView.getContext(), C1103R.string.material_minute_selection));
    }
