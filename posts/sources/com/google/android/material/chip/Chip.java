...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C1103R.C1107style.Widget_MaterialComponents_Chip_Action;
    private static final Rect EMPTY_BOUNDS = new Rect();
    private static final int[] SELECTED_STATE = {16842913};
    private static final int[] CHECKABLE_STATE_SET = {16842911};

    /* loaded from: /home/clement/Documents/site/ma_vie/content/posts/vulnerabilite-izly/resources/classes.dex */
    public class ChipTouchHelper extends AbstractC2229s5 {
        ...
        public void onPopulateNodeForHost(C1617d5 c1617d5) {
            c1617d5.f3986a.setCheckable(Chip.this.isCheckable());
            c1617d5.f3986a.setClickable(Chip.this.isClickable());
            if (!Chip.this.isCheckable() && !Chip.this.isClickable()) {
                c1617d5.f3986a.setClassName(Chip.GENERIC_VIEW_ACCESSIBILITY_CLASS_NAME);
            } else {
                c1617d5.f3986a.setClassName(Chip.this.isCheckable() ? Chip.COMPOUND_BUTTON_ACCESSIBILITY_CLASS_NAME : Chip.BUTTON_ACCESSIBILITY_CLASS_NAME);
            }
            CharSequence text = Chip.this.getText();
            if (Build.VERSION.SDK_INT >= 23) {
                c1617d5.f3986a.setText(text);
            } else {
                c1617d5.f3986a.setContentDescription(text);
            }
        }
        ...
        public void onPopulateNodeForVirtualView(int i, C1617d5 c1617d5) {
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    c1617d5.f3986a.setContentDescription(closeIconContentDescription);
                } else {
                    CharSequence text = Chip.this.getText();
                    Context context = Chip.this.getContext();
                    int i2 = C1103R.string.mtrl_chip_close_icon_content_description;
                    Object[] objArr = new Object[1];
                    objArr[0] = TextUtils.isEmpty(text) ? "" : text;
                    c1617d5.f3986a.setContentDescription(context.getString(i2, objArr).trim());
                }
                c1617d5.f3986a.setBoundsInParent(Chip.this.getCloseIconTouchBoundsInt());
                c1617d5.m1032a(C1617d5.C1618a.f3991g);
                c1617d5.f3986a.setEnabled(Chip.this.isEnabled());
                return;
            }
            c1617d5.f3986a.setContentDescription("");
            c1617d5.f3986a.setBoundsInParent(Chip.EMPTY_BOUNDS);
        }
    ...
    private boolean handleAccessibilityExit(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 10) {
            try {
                Field declaredField = AbstractC2229s5.class.getDeclaredField("mHoveredVirtualViewId");
                declaredField.setAccessible(true);
                if (((Integer) declaredField.get(this.touchHelper)).intValue() != Integer.MIN_VALUE) {
                    Method declaredMethod = AbstractC2229s5.class.getDeclaredMethod("updateHoveredVirtualView", Integer.TYPE);
    ...
    private void initMinTouchTarget(Context context, AttributeSet attributeSet, int i) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C1103R.styleable.Chip, i, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = obtainStyledAttributes.getBoolean(C1103R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil(obtainStyledAttributes.getDimension(C1103R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil(ViewUtils.dpToPx(getContext(), 48))));
    ...
    private void updateAccessibilityDelegate() {
        if (hasCloseIcon() && isCloseIconVisible() && this.onCloseIconClickListener != null) {
            C0492V4.m1950u(this, this.touchHelper);
        } else {
            C0492V4.m1950u(this, null);
        }
    }
    ...
    private void updateBackgroundDrawable() {
        ...
        C0492V4.C0495c.m1927q(this, backgroundDrawable);
    ...
    private void updateFrameworkRippleBackground() {
        ...
        AtomicInteger atomicInteger = C0492V4.f1798a;
        C0492V4.C0495c.m1927q(this, rippleDrawable);
        updatePaddingInternal();
    }
    ...
    private void updatePaddingInternal() {
        ...
        AtomicInteger atomicInteger = C0492V4.f1798a;
        C0492V4.C0496d.m1914k(this, calculateChipIconWidth, paddingTop, calculateCloseIconWidth, paddingBottom);
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (getParent() instanceof ChipGroup) {
            ...
            accessibilityNodeInfo.setCollectionItemInfo((AccessibilityNodeInfo.CollectionItemInfo) C1617d5.C1620c.m1012a(chipGroup.getRowIndex(this), 1, chipGroup.isSingleLine() ? chipGroup.getIndexOfChip(this) : -1, 1, false, isChecked()).f4005a);
        }
    }
    ...
    */
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1103R.attr.chipStyle);
    }
    ...
    */
    public Chip(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            float r0 = p000.C0492V4.C0500h.m1892i(r7)
            r6.setElevation(r0)
            int[] r2 = com.google.android.material.C1103R.styleable.Chip
            r0 = 0
            int[] r5 = new int[r0]
            r0 = r8
            r1 = r9
            ...
            r0 = 23
            if (r10 >= r0) goto L53
            int r10 = com.google.android.material.C1103R.styleable.Chip_android_textColor
            ...
            r7.setTextColor(r8)
        L53:
            int r8 = com.google.android.material.C1103R.styleable.Chip_shapeAppearance
        ...
        L90:
            ...
            r7.setMinHeight(r8)
        La4:
            int r8 = p000.C0492V4.C0496d.m1921d(r7)
