...
public class MaterialRadioButton extends AppCompatRadioButton {
    private static final int DEF_STYLE_RES = C1103R.C1107style.Widget_MaterialComponents_CompoundButton_RadioButton;
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            int color = MaterialColors.getColor(this, C1103R.attr.colorControlActivated);
            int color2 = MaterialColors.getColor(this, C1103R.attr.colorOnSurface);
            int color3 = MaterialColors.getColor(this, C1103R.attr.colorSurface);
    ...
    public MaterialRadioButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C1103R.attr.radioButtonStyle);
    }
    ...
    */
    public MaterialRadioButton(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        /*
            ...
            int[] r2 = com.google.android.material.C1103R.styleable.MaterialRadioButton
            r6 = 0
            int[] r5 = new int[r6]
            r0 = r8
            r1 = r9
            ...
            int r10 = com.google.android.material.C1103R.styleable.MaterialRadioButton_buttonTint
        ...
        L28:
            int r8 = com.google.android.material.C1103R.styleable.MaterialRadioButton_useMaterialThemeColors
