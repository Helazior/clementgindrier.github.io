...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private ViewGroup calculateChildContentContainer(View view) {
        View findViewById = view.findViewById(C1103R.C1106id.mtrl_child_content_container);
    ...
    private void createElevationAnimation(View view, View view2, boolean z, boolean z2, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        float m1892i = C0492V4.C0500h.m1892i(view2) - C0492V4.C0500h.m1892i(view);
        if (z) {
            if (!z2) {
                view2.setTranslationZ(-m1892i);
            }
            ofFloat = ObjectAnimator.ofFloat(view2, View.TRANSLATION_Z, 0.0f);
        } else {
            ofFloat = ObjectAnimator.ofFloat(view2, View.TRANSLATION_Z, -m1892i);
        }
    ...
    private int getBackgroundTint(View view) {
        ...
        if (m1894g != null) {
            return m1894g.getColorForState(view.getDrawableState(), m1894g.getDefaultColor());
        }
        return 0;
    }
