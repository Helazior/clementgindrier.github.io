...
public class BaseImageDecoder implements ImageDecoder {
        ...
        if (imageScaleType == ImageScaleType.EXACTLY || imageScaleType == ImageScaleType.EXACTLY_STRETCHED) {
            ...
            if (Float.compare(computeImageScale, 1.0f) != 0) {
                ...
                if (this.loggingEnabled) {
                    C1564L.m1070d(LOG_SCALE_IMAGE, imageSize, imageSize.scale(computeImageScale), Float.valueOf(computeImageScale), imageDecodingInfo.getImageKey());
                }
            }
        }
        if (z) {
            ...
            if (this.loggingEnabled) {
                C1564L.m1070d(LOG_FLIP_IMAGE, imageDecodingInfo.getImageKey());
            }
        }
        if (i != 0) {
            matrix.postRotate(i);
            if (this.loggingEnabled) {
                C1564L.m1070d(LOG_ROTATE_IMAGE, Integer.valueOf(i), imageDecodingInfo.getImageKey());
            }
        }
    ...
    public Bitmap decode(ImageDecodingInfo imageDecodingInfo) {
        ...
        if (imageStream == null) {
            C1564L.m1069e(ERROR_NO_IMAGE_STREAM, imageDecodingInfo.getImageKey());
            return null;
        }
        try {
            ...
            if (decodeStream == null) {
                C1564L.m1069e(ERROR_CANT_DECODE_IMAGE, imageDecodingInfo.getImageKey());
                return decodeStream;
            }
    ...
    public ExifInfo defineExifOrientation(String str) {
        ...
        try {
            ...
            C1564L.m1065w("Can't read EXIF tags from file [%s]", str);
        }
    ...
    public BitmapFactory.Options prepareDecodingOptions(ImageSize imageSize, ImageDecodingInfo imageDecodingInfo) {
        ...
        if (computeImageSampleSize > 1 && this.loggingEnabled) {
            C1564L.m1070d(LOG_SUBSAMPLE_IMAGE, imageSize, imageSize.scaleDown(computeImageSampleSize), Integer.valueOf(computeImageSampleSize), imageDecodingInfo.getImageKey());
        }
