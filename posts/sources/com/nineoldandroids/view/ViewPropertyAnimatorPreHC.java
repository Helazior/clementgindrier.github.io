...
public class ViewPropertyAnimatorPreHC extends ViewPropertyAnimator {
    ...
    /* renamed from: X */
    private static final int f3927X = 128;

    /* renamed from: Y */
    private static final int f3928Y = 256;
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            if (arrayList != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    ViewPropertyAnimatorPreHC.this.setValue(nameValuesHolder.mNameConstant, (nameValuesHolder.mDeltaValue * animatedFraction) + nameValuesHolder.mFromValue);
                }
            }
