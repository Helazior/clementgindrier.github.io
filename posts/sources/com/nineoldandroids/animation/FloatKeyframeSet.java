...
public class FloatKeyframeSet extends KeyframeSet {
    ...
    public float getFloatValue(float f) {
        ...
        if (i == 2) {
            ...
            return typeEvaluator2 == null ? outline.m270a(floatValue3, floatValue2, f2, floatValue2) : ((Number) typeEvaluator2.evaluate(f2, Float.valueOf(floatValue2), Float.valueOf(floatValue3))).floatValue();
        } else if (f >= 1.0f) {
            ...
            return typeEvaluator3 == null ? outline.m270a(floatValue5, floatValue4, f3, floatValue4) : ((Number) typeEvaluator3.evaluate(f3, Float.valueOf(floatValue4), Float.valueOf(floatValue5))).floatValue();
        } else {
            ...
            while (true) {
                ...
                if (i2 < i3) {
                    ...
                    if (f < floatKeyframe6.getFraction()) {
                        ...
                        return typeEvaluator4 == null ? outline.m270a(floatValue7, floatValue6, fraction5, floatValue6) : ((Number) typeEvaluator4.evaluate(fraction5, Float.valueOf(floatValue6), Float.valueOf(floatValue7))).floatValue();
                    }
                    i2++;
    ...
    @Override // com.nineoldandroids.animation.KeyframeSet
    /* renamed from: clone */
    public FloatKeyframeSet mo2716clone() {
        ArrayList<Keyframe> arrayList = this.mKeyframes;
        int size = arrayList.size();
        Keyframe.FloatKeyframe[] floatKeyframeArr = new Keyframe.FloatKeyframe[size];
        for (int i = 0; i < size; i++) {
            floatKeyframeArr[i] = (Keyframe.FloatKeyframe) arrayList.get(i).mo2717clone();
        }
