...
public final class AnimatorSet extends Animator {
    ...
    public static class Node implements Cloneable {
        ...
        /* renamed from: clone */
        public Node m2715clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo2714clone();
                return node;
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet mo2714clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo2714clone();
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node m2715clone = next.m2715clone();
            hashMap.put(next, m2715clone);
            animatorSet.mNodes.add(m2715clone);
            animatorSet.mNodeMap.put(m2715clone.animation, m2715clone);
            ArrayList arrayList = null;
            m2715clone.dependencies = null;
            m2715clone.tmpDependencies = null;
            m2715clone.nodeDependents = null;
            m2715clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = m2715clone.animation.getListeners();
            if (listeners != null) {
