...
public class SupportRequestManagerFragment extends Fragment {
    ...
    private static AbstractC0216J5 getRootFragmentManager(Fragment fragment) {
    ...
    private void registerFragmentWithRoot(Context context, AbstractC0216J5 abstractC0216J5) {
        unregisterFragmentWithRoot();
        SupportRequestManagerFragment supportRequestManagerFragment = Glide.get(context).getRequestManagerRetriever().getSupportRequestManagerFragment(context, abstractC0216J5);
    ...
    public void onAttach(Context context) {
        ...
        AbstractC0216J5 rootFragmentManager = getRootFragmentManager(this);
    ...
    public void setParentFragmentHint(Fragment fragment) {
        AbstractC0216J5 rootFragmentManager;
