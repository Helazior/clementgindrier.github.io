...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    public final Map<AbstractC0216J5, SupportRequestManagerFragment> pendingSupportRequestManagerFragments = new HashMap();
    private final C2339x1<View, Fragment> tempViewToSupportFragment = new C2339x1<>();
    private final C2339x1<View, android.app.Fragment> tempViewToFragment = new C2339x1<>();
    ...
    @TargetApi(26)
    @Deprecated
    private void findAllFragmentsWithViews(FragmentManager fragmentManager, C2339x1<View, android.app.Fragment> c2339x1) {
        if (Build.VERSION.SDK_INT >= 26) {
            for (android.app.Fragment fragment : fragmentManager.getFragments()) {
                if (fragment.getView() != null) {
                    c2339x1.put(fragment.getView(), fragment);
                    findAllFragmentsWithViews(fragment.getChildFragmentManager(), c2339x1);
                }
            }
            return;
        }
        findAllFragmentsWithViewsPreO(fragmentManager, c2339x1);
    }

    @Deprecated
    private void findAllFragmentsWithViewsPreO(FragmentManager fragmentManager, C2339x1<View, android.app.Fragment> c2339x1) {
        int i = 0;
        while (true) {
            int i2 = i + 1;
    ...
    private static void findAllSupportFragmentsWithViews(Collection<Fragment> collection, Map<View, Fragment> map) {
        ...
        for (Fragment fragment : collection) {
            if (fragment != null && fragment.getView() != null) {
                ...
                findAllSupportFragmentsWithViews(fragment.getChildFragmentManager().mo2299f(), map);
            }
        }
    }
    ...
    private Fragment findSupportFragment(View view, FragmentActivity fragmentActivity) {
        ...
        findAllSupportFragmentsWithViews(fragmentActivity.m1445u().mo2299f(), this.tempViewToSupportFragment);
    ...
    private RequestManager supportFragmentGet(Context context, AbstractC0216J5 abstractC0216J5, Fragment fragment, boolean z) {
        SupportRequestManagerFragment supportRequestManagerFragment = getSupportRequestManagerFragment(abstractC0216J5, fragment, z);
    ...
    public SupportRequestManagerFragment getSupportRequestManagerFragment(Context context, AbstractC0216J5 abstractC0216J5) {
        return getSupportRequestManagerFragment(abstractC0216J5, null, isActivityVisible(context));
    }
    ...
    public boolean handleMessage(Message message) {
        ...
        if (i == 1) {
            ...
            obj = (AbstractC0216J5) message.obj;
    ...
    private SupportRequestManagerFragment getSupportRequestManagerFragment(AbstractC0216J5 abstractC0216J5, Fragment fragment, boolean z) {
        SupportRequestManagerFragment supportRequestManagerFragment = (SupportRequestManagerFragment) abstractC0216J5.mo2303d(FRAGMENT_TAG);
        if (supportRequestManagerFragment == null && (supportRequestManagerFragment = this.pendingSupportRequestManagerFragments.get(abstractC0216J5)) == null) {
            ...
            this.pendingSupportRequestManagerFragments.put(abstractC0216J5, supportRequestManagerFragment);
            AbstractC0352P5 mo2309a = abstractC0216J5.mo2309a();
            mo2309a.mo2150f(0, supportRequestManagerFragment, FRAGMENT_TAG, 1);
            mo2309a.mo2152d();
            this.handler.obtainMessage(2, abstractC0216J5).sendToTarget();
        }
    ...
    public RequestManager get(FragmentActivity fragmentActivity) {
        ...
        return supportFragmentGet(fragmentActivity, fragmentActivity.m1445u(), null, isActivityVisible(fragmentActivity));
    }
