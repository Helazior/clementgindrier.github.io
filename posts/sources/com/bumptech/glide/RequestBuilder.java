...
public class RequestBuilder<TranscodeType> extends BaseRequestOptions<RequestBuilder<TranscodeType>> implements Cloneable, ModelTypes<RequestBuilder<TranscodeType>> {
    ...
    public static /* synthetic */ class C10081 {
        ...
        static {
            ...
            try {
                int[] iArr2 = $SwitchMap$com$bumptech$glide$Priority;
                Priority priority2 = Priority.NORMAL;
                iArr2[2] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                int[] iArr3 = $SwitchMap$com$bumptech$glide$Priority;
                Priority priority3 = Priority.HIGH;
                iArr3[1] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                int[] iArr4 = $SwitchMap$com$bumptech$glide$Priority;
    ...
    private Priority getThumbnailPriority(Priority priority) {
        ...
        if (ordinal != 2) {
            ...
            StringBuilder m253r = outline.m253r("unknown priority: ");
            m253r.append(getPriority());
    ...
    @Override // com.bumptech.glide.request.BaseRequestOptions
    /* renamed from: clone */
    public RequestBuilder<TranscodeType> mo2711clone() {
        RequestBuilder<TranscodeType> requestBuilder = (RequestBuilder) super.mo2711clone();
        requestBuilder.transitionOptions = (TransitionOptions<?, ? super TranscodeType>) requestBuilder.transitionOptions.m2712clone();
    ...
    public ViewTarget<ImageView, TranscodeType> into(ImageView imageView) {
        ...
        if (!isTransformationSet() && isTransformationAllowed() && imageView.getScaleType() != null) {
            switch (C10081.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
                case 1:
