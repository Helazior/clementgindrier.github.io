...
public class HttpUrlFetcher implements DataFetcher<InputStream> {
    ...
    private InputStream getStreamForSuccessfulRequest(HttpURLConnection httpURLConnection) {
        if (TextUtils.isEmpty(httpURLConnection.getContentEncoding())) {
            ...
            if (Log.isLoggable(TAG, 3)) {
                StringBuilder m253r = outline.m253r("Got non empty content encoding: ");
                m253r.append(httpURLConnection.getContentEncoding());
    ...
    public void loadData(Priority priority, DataFetcher.DataCallback<? super InputStream> dataCallback) {
        ...
        try {
            ...
            if (Log.isLoggable(TAG, 2)) {
                StringBuilder m253r = outline.m253r("Finished http url fetcher fetch in ");
