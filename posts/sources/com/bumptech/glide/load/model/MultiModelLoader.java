...
public class MultiModelLoader<Model, Data> implements ModelLoader<Model, Data> {
    private final InterfaceC0037B4<List<Throwable>> exceptionListPool;
    ...
    public static class MultiFetcher<Data> implements DataFetcher<Data>, DataFetcher.DataCallback<Data> {
        ...
        public MultiFetcher(List<DataFetcher<Data>> list, InterfaceC0037B4<List<Throwable>> interfaceC0037B4) {
            this.throwableListPool = interfaceC0037B4;
    ...
    public MultiModelLoader(List<ModelLoader<Model, Data>> list, InterfaceC0037B4<List<Throwable>> interfaceC0037B4) {
        this.modelLoaders = list;
        this.exceptionListPool = interfaceC0037B4;
    }
    ...
    public String toString() {
        StringBuilder m253r = outline.m253r("MultiModelLoader{modelLoaders=");
        m253r.append(Arrays.toString(this.modelLoaders.toArray()));
        m253r.append('}');
