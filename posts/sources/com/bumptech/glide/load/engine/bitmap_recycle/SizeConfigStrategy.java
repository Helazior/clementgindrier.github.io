...
public class SizeConfigStrategy implements LruPoolStrategy {
    ...
    private static Bitmap.Config[] getInConfigs(Bitmap.Config config) {
        ...
        int i = C10331.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
    ...
    public String toString() {
        StringBuilder m253r = outline.m253r("SizeConfigStrategy{groupedMap=");
        m253r.append(this.groupedMap);
        m253r.append(", sortedSizes=(");
