...
public final class GlideException extends Exception {
    ...
    public String getMessage() {
        ...
        if (this.dataSource != null) {
            ...
            m253r2.append(this.dataSource);
            str2 = m253r2.toString();
        } else {
            str2 = "";
        }
        sb.append(str2);
        if (this.key != null) {
            ...
            m253r3.append(this.key);
            str3 = m253r3.toString();
        }
        sb.append(str3);
    ...
    public void logRootCauses(String str) {
        ...
        int i = 0;
        while (i < size) {
            StringBuilder m253r = outline.m253r("Root cause (");
            int i2 = i + 1;
            m253r.append(i2);
            m253r.append(" of ");
            m253r.append(size);
            m253r.append(")");
            Log.i(str, m253r.toString(), rootCauses.get(i));
            i = i2;
        }
    }
