...
public final class DefaultImageHeaderParser implements ImageHeaderParser {
    ...
    public static final byte[] JPEG_EXIF_SEGMENT_PREAMBLE_BYTES = JPEG_EXIF_SEGMENT_PREAMBLE.getBytes(Charset.forName(Key.STRING_CHARSET_NAME));
    ...
    public static final class StreamReader implements Reader {
        ...
        /* renamed from: is */
        private final InputStream f3843is;

        public StreamReader(InputStream inputStream) {
            this.f3843is = inputStream;
        }
        ...
        public int read(byte[] bArr, int i) {
            int i2 = 0;
            int i3 = 0;
            while (i2 < i && (i3 = this.f3843is.read(bArr, i2, i - i2)) != -1) {
                i2 += i3;
            }
            if (i2 == 0 && i3 == -1) {
                throw new Reader.EndOfFileException();
        ...
        public long skip(long j) {
            ...
            long j2 = j;
            while (j2 > 0) {
                long skip = this.f3843is.skip(j2);
                if (skip <= 0) {
                    if (this.f3843is.read() == -1) {
                        break;
                    }
                    skip = 1;
                }
