...
public class VideoDecoder<T> implements ResourceDecoder<T, Bitmap> {
    ...
    public Resource<Bitmap> decode(T t, int i, int i2, Options options) {
        long longValue = ((Long) options.get(TARGET_FRAME)).longValue();
        if (longValue < 0 && longValue != -1) {
            throw new IllegalArgumentException(outline.m272I("Requested frame must be non-negative, or DEFAULT_FRAME, given: ", longValue));
        }
