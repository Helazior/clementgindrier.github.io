    ...
    private static void initializeGlide(Context context, GlideBuilder glideBuilder, GeneratedAppGlideModule generatedAppGlideModule) {
        ...
        if (Log.isLoggable(TAG, 3)) {
            for (GlideModule glideModule : emptyList) {
                StringBuilder m253r = outline.m253r("Discovered GlideModule from manifest: ");
                m253r.append(glideModule.getClass());
        ...
        for (GlideModule glideModule3 : emptyList) {
            try {
                ...
                StringBuilder m253r2 = outline.m253r("Attempting to register a Glide v3 module. If you see this, you or one of your dependencies may be including Glide v3 even though you're using Glide v4. You'll need to find and remove (or update) the offending dependency. The v3 module name is: ");
                m253r2.append(glideModule3.getClass().getName());
                throw new IllegalStateException(m253r2.toString(), e);
            }
        }
        if (generatedAppGlideModule != null) {
