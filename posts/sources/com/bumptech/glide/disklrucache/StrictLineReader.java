...
public class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f3825CR = 13;

    /* renamed from: LF */
    private static final byte f3826LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* renamed from: in */
    private final InputStream f3827in;
    private int pos;
    ...
    private void fillBuf() {
        InputStream inputStream = this.f3827in;
        byte[] bArr = this.buf;
