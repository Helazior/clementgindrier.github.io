...
/* renamed from: fr.smoney.android.izly.ui.privateview.useraccount.cancelcontract.CancelContractConfirmationActivity */
/* loaded from: /home/clement/Documents/site/ma_vie/content/posts/vulnerabilite-izly/resources/classes.dex */
public final class CancelContractConfirmationActivity extends SmoneyABSActivity<AbstractC0614aa> implements View.OnClickListener, SmoneyRequestManager.InterfaceC1778a {
    ...
    public void mo240g(int i, int i2, int i3, @NotNull Bundle bundle) {
        ...
        if (this.f4197r.m108o(i, i2, i3, bundle)) {
            ...
            if (serverError != null) {
                ...
                startActivity(new Intent(this, CancelContractCodeActivity.class));
            }
        }
    }
    ...
    public void mo235n(int i) {
        ...
        String str = c0479u8.f1753v0;
        ServerError serverError = c0479u8.f1755w0;
        if (serverError != null) {
    ...
    public void onClick(@Nullable View view) {
        int i;
        if (C0581Yd.m1770a(view, ((AbstractC0614aa) this.f4202w).f2176c)) {
            C2329w8 c2329w8 = this.f4197r;
            ...
            while (true) {
                if (i2 < size) {
                    ...
                    if (valueAt.getIntExtra("com.foxykeep.datadroid.extras.workerType", -1) == 279 && valueAt.getStringExtra("fr.smoney.android.izly.extras.sendConfirmationCodeUserId").equals(str) && valueAt.getStringExtra("fr.smoney.android.izly.extras.sendConfirmationCodeSessionId").equals(str2)) {
                    ...
                    intent.putExtra("com.foxykeep.datadroid.extras.workerType", 279);
                    ...
                    intent.putExtra("fr.smoney.android.izly.extras.sendConfirmationCodeUserId", str);
                    intent.putExtra("fr.smoney.android.izly.extras.sendConfirmationCodeSessionId", str2);
            ...
            this.f4197r.m120c(i, 279, true);
        } else if (C0581Yd.m1770a(view, ((AbstractC0614aa) this.f4202w).f2175b)) {
            this.f2196f.m1721a();
        }
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        ((AbstractC0614aa) this.f4202w).f2176c.setOnClickListener(this);
        ((AbstractC0614aa) this.f4202w).f2175b.setOnClickListener(this);
    }
