    ...
    public OkHttpClient(Builder builder) {
        ...
        if (!this.interceptors.contains(null)) {
            if (this.networkInterceptors.contains(null)) {
                StringBuilder m253r = outline.m253r("Null network interceptor: ");
                m253r.append(this.networkInterceptors);
                throw new IllegalStateException(m253r.toString());
            }
            return;
        }
        StringBuilder m253r2 = outline.m253r("Null interceptor: ");
        m253r2.append(this.interceptors);
