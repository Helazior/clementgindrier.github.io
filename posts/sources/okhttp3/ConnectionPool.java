...
public final class ConnectionPool {
    ...
    private int pruneAndGetAllocationCount(RealConnection realConnection, long j) {
        ...
        while (i < list.size()) {
            ...
            if (reference.get() != null) {
                ...
                StringBuilder m253r = outline.m253r("A connection to ");
                m253r.append(realConnection.route().address().url());
                m253r.append(" was leaked. Did you forget to close a response body?");
                Platform.get().logCloseableLeak(m253r.toString(), ((StreamAllocation.StreamAllocationReference) reference).callStackTrace);
                list.remove(i);
    ...
    public ConnectionPool(int i, long j, TimeUnit timeUnit) {
        ...
        if (j <= 0) {
            throw new IllegalArgumentException(outline.m272I("keepAliveDuration <= 0: ", j));
        }
    }
}
