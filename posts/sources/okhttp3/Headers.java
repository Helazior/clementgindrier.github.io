...
public final class Headers {
    ...
    /* renamed from: of */
    public static Headers m530of(String... strArr) {
    ...
    public static final class Builder {
        ...
        private void checkNameAndValue(String str, String str2) {
            ...
            if (!str.isEmpty()) {
                ...
                throw new NullPointerException(outline.m265f("value for name ", str, " == null"));
            }
        ...
        public Builder add(String str) {
            ...
            throw new IllegalArgumentException(outline.m266e("Unexpected header: ", str));
        }
    ...
    /* renamed from: of */
    public static Headers m531of(Map<String, String> map) {
