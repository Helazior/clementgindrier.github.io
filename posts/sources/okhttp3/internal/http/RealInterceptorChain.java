    ...
    public Response proceed(Request request, StreamAllocation streamAllocation, HttpCodec httpCodec, RealConnection realConnection) {
        if (this.index < this.interceptors.size()) {
            ...
            if (this.httpCodec != null && !this.connection.supportsUrl(request.url())) {
                StringBuilder m253r = outline.m253r("network interceptor ");
                m253r.append(this.interceptors.get(this.index - 1));
                m253r.append(" must retain the same host and port");
                throw new IllegalStateException(m253r.toString());
            } else if (this.httpCodec != null && this.calls > 1) {
                StringBuilder m253r2 = outline.m253r("network interceptor ");
                m253r2.append(this.interceptors.get(this.index - 1));
                m253r2.append(" must call proceed() exactly once");
