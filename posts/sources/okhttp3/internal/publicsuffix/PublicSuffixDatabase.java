...
public final class PublicSuffixDatabase {
    ...
    private void readTheList() {
        ...
        C2358xe c2358xe = new C2358xe(new C2220re(C2263te.m334f(resourceAsStream)));
        try {
            byte[] bArr = new byte[c2358xe.readInt()];
            c2358xe.readFully(bArr);
            byte[] bArr2 = new byte[c2358xe.readInt()];
            c2358xe.readFully(bArr2);
            synchronized (this) {
