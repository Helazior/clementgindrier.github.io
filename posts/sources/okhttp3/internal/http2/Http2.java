...
public final class Http2 {
    ...
    public static final C2011ne CONNECTION_PREFACE = C2011ne.m557f("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");
    ...
    static {
        ...
        for (int i3 = 0; i3 < 1; i3++) {
            ...
            strArr3[i4 | 8] = outline.m262i(new StringBuilder(), strArr3[i4], "|PADDED");
        }
        ...
        for (int i5 = 0; i5 < 3; i5++) {
            ...
            for (int i7 = 0; i7 < 1; i7++) {
                ...
                sb.append('|');
                strArr5[i9 | 8] = outline.m262i(sb, strArr5[i6], "|PADDED");
            }
        }
        while (true) {
