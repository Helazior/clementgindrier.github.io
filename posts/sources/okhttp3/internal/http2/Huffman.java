...
public class Huffman {
    ...
    public void encode(C2011ne c2011ne, InterfaceC1966le interfaceC1966le) {
        int i = 0;
        long j = 0;
        byte b = 0;
        while (i < c2011ne.mo550m()) {
            int mo556g = c2011ne.mo556g(i) & 255;
            int i2 = CODES[mo556g];
            byte b2 = CODE_LENGTHS[mo556g];
            j = (j << b2) | i2;
            int i3 = b + b2;
            while (i3 >= 8) {
                i3 = (i3 == 1 ? 1 : 0) - 8;
                interfaceC1966le.mo142n((int) (j >> i3));
            }
            i++;
            b = i3;
        }
        if (b > 0) {
            interfaceC1966le.mo142n((int) ((255 >>> b) | (j << (8 - b))));
        }
    }

    public int encodedLength(C2011ne c2011ne) {
        long j = 0;
        for (int i = 0; i < c2011ne.mo550m(); i++) {
            j += CODE_LENGTHS[c2011ne.mo556g(i) & 255];
        }
        return (int) ((j + 7) >> 3);
    }
