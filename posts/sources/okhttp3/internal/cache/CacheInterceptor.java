...
public final class CacheInterceptor implements Interceptor {
    ...
    private Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) {
        InterfaceC0050Be body;
        if (cacheRequest == null || (body = cacheRequest.body()) == null) {
            return response;
        }
        final InterfaceC1987me source = response.body().source();
        Logger logger = C2263te.f6595a;
        final C2335we c2335we = new C2335we(body);
        return response.newBuilder().body(new RealResponseBody(response.header("Content-Type"), response.body().contentLength(), new C2358xe(new InterfaceC0073Ce() { // from class: okhttp3.internal.cache.CacheInterceptor.1
            ...
            public long read(C1946ke c1946ke, long j) {
                try {
                    long read = source.read(c1946ke, j);
                    if (read == -1) {
                    ...
                    c1946ke.m673H(c2335we.mo91a(), c1946ke.f5398b - read, read);
                    c2335we.mo139t();
                    return read;
                } catch (IOException e) {
                    if (!this.cacheRequestClosed) {
