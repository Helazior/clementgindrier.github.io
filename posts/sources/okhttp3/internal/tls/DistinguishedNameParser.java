...
public final class DistinguishedNameParser {
    ...
    */
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                StringBuilder m253r = outline.m253r("Malformed DN: ");
                m253r.append(this.f5630dn);
            ...
            if (c2 >= '0' && c2 <= '9') {
                ...
                StringBuilder m253r2 = outline.m253r("Malformed DN: ");
                m253r2.append(this.f5630dn);
        ...
        StringBuilder m253r3 = outline.m253r("Malformed DN: ");
        m253r3.append(this.f5630dn);
        throw new IllegalStateException(m253r3.toString());
    }
    ...
    private char getEscaped() {
        ...
        StringBuilder m253r = outline.m253r("Unexpected end of DN: ");
        m253r.append(this.f5630dn);
        throw new IllegalStateException(m253r.toString());
    }
    ...
    private String hexAV() {
        ...
        StringBuilder m253r2 = outline.m253r("Unexpected end of DN: ");
        m253r2.append(this.f5630dn);
        throw new IllegalStateException(m253r2.toString());
    }
    ...
    public String findMostSpecific(String str) {
        ...
        this.end = 0;
        this.cur = 0;
        this.chars = this.f5630dn.toCharArray();
