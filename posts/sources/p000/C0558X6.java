...
public class C0558X6 extends RecyclerView.AbstractC0857x {
    ...
    public C0558X6(Context context) {
    ...
    public int calculateDxToMakeVisible(View view, int i) {
        RecyclerView.AbstractC0843o layoutManager = getLayoutManager();
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.AbstractC0857x
    public void onSeekTargetStep(int i, int i2, RecyclerView.C0860y c0860y, RecyclerView.AbstractC0857x.C0858a c0858a) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
        ...
        if (this.mInterimTargetDx == 0 && clampApplyScroll == 0) {
            updateActionForInterimTarget(c0858a);
        }
    }
    ...
    public void onTargetFound(View view, RecyclerView.C0860y c0860y, RecyclerView.AbstractC0857x.C0858a c0858a) {
        ...
        if (calculateTimeForDeceleration > 0) {
            c0858a.m1343b(-calculateDxToMakeVisible, -calculateDyToMakeVisible, calculateTimeForDeceleration, this.mDecelerateInterpolator);
        }
    }

    public void updateActionForInterimTarget(RecyclerView.AbstractC0857x.C0858a c0858a) {
        ...
        if (computeScrollVectorForPosition != null && (computeScrollVectorForPosition.x != 0.0f || computeScrollVectorForPosition.y != 0.0f)) {
            ...
            c0858a.m1343b((int) (this.mInterimTargetDx * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (this.mInterimTargetDy * TARGET_SEEK_EXTRA_SCROLL_RATIO), (int) (calculateTimeForScrolling(TARGET_SEEK_SCROLL_DISTANCE_PX) * TARGET_SEEK_EXTRA_SCROLL_RATIO), this.mLinearInterpolator);
            return;
        }
        c0858a.f3261d = getTargetPosition();
        stop();
    }
}
