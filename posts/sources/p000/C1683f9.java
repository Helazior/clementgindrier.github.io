...
public final class C1683f9 {
    @Nullable
    /* renamed from: a */
    public static final Bundle m984a(@NotNull String str, @NotNull String str2) {
        String str3;
        C0581Yd.m1766e(str, "userId");
        C0581Yd.m1766e(str2, "sessionId");
        C0973b9 c0973b9 = new C0973b9("https://rest.izly.fr/Service/PublicService.svc/rest/CheckTerminateContractIzlyMobile");
        c0973b9.m1145a("1.0");
        ...
        if (SmoneyService.m946g(i)) {
            ...
            if (str3 == null) {
                bundle.putString("fr.smoney.android.izly.extras.CheckTerminateContract", str3);
            }
        }
        return bundle;
    }
