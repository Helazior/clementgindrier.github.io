...
public class C0162H {
    ...
    private static final C0101E1<String, Constructor<? extends View>> sConstructorMap = new C0101E1<>();

    /* renamed from: H$a */
    /* loaded from: /home/clement/Documents/site/ma_vie/content/posts/vulnerabilite-izly/resources/classes.dex */
    public static class View$OnClickListenerC0163a implements View.OnClickListener {
        ...
        public View$OnClickListenerC0163a(View view, String str) {
            this.f517a = view;
            this.f518b = str;
        }
        ...
        public void onClick(View view) {
            ...
            if (this.f519c == null) {
                ...
                while (context != null) {
                    try {
                        if (!context.isRestricted() && (method = context.getClass().getMethod(this.f518b, View.class)) != null) {
                            this.f519c = method;
                            this.f520d = context;
                        }
                ...
                int id = this.f517a.getId();
                if (id == -1) {
                    sb = "";
                } else {
                    StringBuilder m253r = outline.m253r(" with id '");
                    m253r.append(this.f517a.getContext().getResources().getResourceEntryName(id));
                    m253r.append("'");
                    sb = m253r.toString();
                }
                StringBuilder m253r2 = outline.m253r("Could not find method ");
                m253r2.append(this.f518b);
                m253r2.append("(View) in a parent or ancestor Context for android:onClick attribute defined on view ");
                m253r2.append(this.f517a.getClass());
                m253r2.append(sb);
                throw new IllegalStateException(m253r2.toString());
            }
            try {
                this.f519c.invoke(this.f520d, view);
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (context instanceof ContextWrapper) {
            ...
            if (C0492V4.C0494b.m1944a(view)) {
                TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, sOnClickAttrs);
                String string = obtainStyledAttributes.getString(0);
                if (string != null) {
                    view.setOnClickListener(new View$OnClickListenerC0163a(view, string));
                }
    ...
    private View createViewByPrefix(Context context, String str, String str2) {
        String str3;
        C0101E1<String, Constructor<? extends View>> c0101e1 = sConstructorMap;
        Constructor<? extends View> constructor = c0101e1.get(str);
        if (constructor == null) {
            if (str2 != null) {
                try {
                    str3 = str2 + str;
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2012o.View, 0, 0);
        int resourceId = z ? obtainStyledAttributes.getResourceId(C2012o.View_android_theme, 0) : 0;
        if (z2 && resourceId == 0 && (resourceId = obtainStyledAttributes.getResourceId(C2012o.View_theme, 0)) != 0) {
            Log.i(LOG_TAG, "app:theme is now deprecated. Please move to using android:theme instead.");
        }
        obtainStyledAttributes.recycle();
        return resourceId != 0 ? ((context instanceof C0546X) && ((C0546X) context).f1952a == resourceId) ? context : new C0546X(context, resourceId) : context;
    }
