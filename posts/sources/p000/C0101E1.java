...
public class C0101E1<K, V> {
    ...
    public C0101E1() {
        this.mHashes = C0015A1.f111a;
        this.mArray = C0015A1.f113c;
        this.mSize = 0;
    }

    private void allocArrays(int i) {
        if (i == 8) {
            synchronized (C0101E1.class) {
    ...
    private static int binarySearchHashes(int[] iArr, int i, int i2) {
        try {
            return C0015A1.m2597a(iArr, i, i2);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof C0101E1) {
            C0101E1 c0101e1 = (C0101E1) obj;
            if (size() != c0101e1.size()) {
                return false;
            }
            for (int i = 0; i < this.mSize; i++) {
                try {
                    K keyAt = keyAt(i);
                    V valueAt = valueAt(i);
                    Object obj2 = c0101e1.get(keyAt);
                    if (valueAt == null) {
                        if (obj2 != null || !c0101e1.containsKey(keyAt)) {
                            return false;
                        }
    ...
    public void putAll(C0101E1<? extends K, ? extends V> c0101e1) {
        ...
        if (this.mSize != 0) {
            for (int i2 = 0; i2 < i; i2++) {
                put(c0101e1.keyAt(i2), c0101e1.valueAt(i2));
            }
        } else if (i > 0) {
            System.arraycopy(c0101e1.mHashes, 0, this.mHashes, 0, i);
            System.arraycopy(c0101e1.mArray, 0, this.mArray, 0, i << 1);
            this.mSize = i;
        }
    }
    ...
    public C0101E1(C0101E1<K, V> c0101e1) {
        this();
        if (c0101e1 != 0) {
            putAll(c0101e1);
        }
