...
public class C0232K1 extends AbstractC0166H1 {
    ...
    public C0232K1(double[] dArr, double[][] dArr2) {
    ...
    /* renamed from: h */
    public static double m2349h(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d2 * 6.0d;
    ...
    /* renamed from: i */
    public static double m2348i(double d, double d2, double d3, double d4, double d5, double d6) {
        double d7 = d2 * d2;
        double d8 = d7 * d2;
        double d9 = 3.0d * d7;
        double d10 = d9 * d4;
    ...
    public double mo2355b(double d, int i) {
        double[] dArr = this.f718a;
        int length = dArr.length;
        int i2 = 0;
        if (d <= dArr[0]) {
            return this.f719b[0][i];
        }
        int i3 = length - 1;
        if (d >= dArr[i3]) {
            return this.f719b[i3][i];
        }
        while (i2 < i3) {
            double[] dArr2 = this.f718a;
            if (d == dArr2[i2]) {
                return this.f719b[i2][i];
            }
            int i4 = i2 + 1;
            if (d < dArr2[i4]) {
                double d2 = dArr2[i4] - dArr2[i2];
                double d3 = (d - dArr2[i2]) / d2;
                double[][] dArr3 = this.f719b;
                double d4 = dArr3[i2][i];
                double d5 = dArr3[i4][i];
                double[][] dArr4 = this.f720c;
                return m2348i(d2, d3, d4, d5, dArr4[i2][i], dArr4[i4][i]);
            }
            i2 = i4;
        }
    ...
    public void mo2354c(double d, double[] dArr) {
        ...
        int i = 0;
        int length2 = this.f719b[0].length;
        if (d <= dArr2[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                dArr[i2] = this.f719b[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f718a[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    dArr[i5] = this.f719b[i4][i5];
                }
            }
            double[] dArr3 = this.f718a;
            int i6 = i4 + 1;
            if (d < dArr3[i6]) {
                double d2 = dArr3[i6] - dArr3[i4];
                double d3 = (d - dArr3[i4]) / d2;
                while (i < length2) {
                    double[][] dArr4 = this.f719b;
                    double d4 = dArr4[i4][i];
                    double d5 = dArr4[i6][i];
                    double[][] dArr5 = this.f720c;
                    dArr[i] = m2348i(d2, d3, d4, d5, dArr5[i4][i], dArr5[i6][i]);
                    i++;
                }
                return;
            }
    ...
    public void mo2353d(double d, float[] fArr) {
        ...
        while (i4 < i3) {
            if (d == this.f718a[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    fArr[i5] = (float) this.f719b[i4][i5];
                }
            }
            double[] dArr2 = this.f718a;
            int i6 = i4 + 1;
            if (d < dArr2[i6]) {
                ...
                while (i < length2) {
                    ...
                    double[][] dArr4 = this.f720c;
                    fArr[i] = (float) m2348i(d2, d3, d4, d5, dArr4[i4][i], dArr4[i6][i]);
                    i++;
                }
                return;
            }
    ...
    public double mo2352e(double d, int i) {
        ...
        while (i2 < length - 1) {
            ...
            if (d2 <= dArr2[i4]) {
                ...
                double d5 = dArr3[i4][i];
                double[][] dArr4 = this.f720c;
                return m2349h(d3, (d2 - dArr2[i2]) / d3, d4, d5, dArr4[i2][i], dArr4[i4][i]) / d3;
            }
            i2 = i4;
        }
        return ShadowDrawableWrapper.COS_45;
        ...
        while (i2 < length - 1) {
            ...
            if (d2 <= dArr3[i3]) {
                ...
                for (int i4 = 0; i4 < length2; i4++) {
                    ...
                    double[][] dArr5 = this.f720c;
                    dArr[i4] = m2349h(d3, d4, d5, d6, dArr5[i2][i4], dArr5[i3][i4]) / d3;
                }
                return;
            }
            i2 = i3;
