...
public class RIPEMD160 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            StringBuilder m249v = outline.m249v(sb, str, "$Digest", configurableProvider, "MessageDigest.RIPEMD160");
            m249v.append("Alg.Alias.MessageDigest.");
            StringBuilder m246y = outline.m246y(m249v, TeleTrusTObjectIdentifiers.ripemd160, configurableProvider, "RIPEMD160", str);
            m246y.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "RIPEMD160", m246y.toString(), outline.m266e(str, "$KeyGenerator"));
