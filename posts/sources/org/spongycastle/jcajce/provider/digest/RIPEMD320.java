...
public class RIPEMD320 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addHMACAlgorithm(configurableProvider, "RIPEMD320", outline.m262i(outline.m249v(sb, str, "$Digest", configurableProvider, "MessageDigest.RIPEMD320"), str, "$HashMac"), outline.m266e(str, "$KeyGenerator"));
        }
    }
}
