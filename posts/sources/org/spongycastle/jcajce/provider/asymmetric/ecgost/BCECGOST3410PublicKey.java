...
public class BCECGOST3410PublicKey implements ECPublicKey, org.spongycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    /* renamed from: q */
    private transient ECPoint f6087q;
    private boolean withCompression;

    public BCECGOST3410PublicKey(BCECGOST3410PublicKey bCECGOST3410PublicKey) {
        this.algorithm = "ECGOST3410";
        this.f6087q = bCECGOST3410PublicKey.f6087q;
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (subjectPublicKeyInfo.getAlgorithm().getAlgorithm().equals(CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                GOST3410PublicKeyAlgParameters gOST3410PublicKeyAlgParameters = new GOST3410PublicKeyAlgParameters((ASN1Sequence) subjectPublicKeyInfo.getAlgorithm().getParameters());
                ...
                this.f6087q = curve2.createPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2), false);
        ...
        this.f6087q = new X9ECPoint(curve, dEROctetString).getPoint();
    }
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f6087q.getX().toBigInteger();
            BigInteger bigInteger2 = this.f6087q.getY().toBigInteger();
            ...
            subjectPublicKeyInfo = new SubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, (ASN1Encodable) x962Parameters), ((ASN1OctetString) new X9ECPoint(engineGetQ().getCurve().createPoint(getQ().getX().toBigInteger(), getQ().getY().toBigInteger(), this.withCompression)).toASN1Primitive()).getOctets());
        }
    ...
    public ECPoint getQ() {
        if (this.ecSpec == null) {
            if (this.f6087q instanceof ECPoint.C2162Fp) {
                return new ECPoint.C2162Fp(null, this.f6087q.getX(), this.f6087q.getY());
            }
            return new ECPoint.F2m(null, this.f6087q.getX(), this.f6087q.getY());
        }
        return this.f6087q;
    }
    ...
    public java.security.spec.ECPoint getW() {
        return new java.security.spec.ECPoint(this.f6087q.getX().toBigInteger(), this.f6087q.getY().toBigInteger());
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f6087q.getX().toBigInteger().toString(16));
        stringBuffer.append(property);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f6087q.getY().toBigInteger().toString(16));
        stringBuffer.append(property);
    ...
    public BCECGOST3410PublicKey(ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f6087q = EC5Util.convertPoint(params, eCPublicKeySpec.getW(), false);
    }

    public BCECGOST3410PublicKey(org.spongycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        this.algorithm = "ECGOST3410";
        this.f6087q = eCPublicKeySpec.getQ();
        ...
        if (this.f6087q.getCurve() == null) {
            this.f6087q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f6087q.getX().toBigInteger(), this.f6087q.getY().toBigInteger(), false);
        }
        this.ecSpec = null;
    }
    ...
    public BCECGOST3410PublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters, ECParameterSpec eCParameterSpec) {
        ...
        this.algorithm = str;
        this.f6087q = eCPublicKeyParameters.getQ();
        if (eCParameterSpec == null) {
    ...
    public BCECGOST3410PublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f6087q = EC5Util.convertPoint(params, eCPublicKey.getW(), false);
    }
