...
public interface X9ObjectIdentifiers {
    ...
    static {
        ...
        tpBasis = branch.branch("2.3.2");
        ppBasis = branch.branch(BuildConfig.VERSION_NAME);
        ASN1ObjectIdentifier branch2 = aSN1ObjectIdentifier.branch("4");
        id_ecSigType = branch2;
        ecdsa_with_SHA1 = new ASN1ObjectIdentifier(outline.m260k(branch2, ".1"));
        ...
        ASN1ObjectIdentifier branch6 = branch5.branch(CrashlyticsReportDataCapture.SIGNAL_DEFAULT);
        cTwoCurve = branch6;
