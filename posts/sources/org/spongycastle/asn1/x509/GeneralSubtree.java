        ...
        if (size != 1) {
            if (size == 2) {
                ...
                if (aSN1TaggedObject2.getTagNo() == 0) {
                    ...
                    throw new IllegalArgumentException(outline.m257n(aSN1TaggedObject3, outline.m253r("Bad tag number for 'maximum': ")));
                }
                throw new IllegalArgumentException(outline.m257n(aSN1TaggedObject2, outline.m253r("Bad tag number for 'minimum': ")));
            } else {
