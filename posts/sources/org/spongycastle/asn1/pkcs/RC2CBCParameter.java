...
public class RC2CBCParameter extends ASN1Object {
    ...
    /* renamed from: iv */
    public ASN1OctetString f5674iv;
    public ASN1Integer version;

    public RC2CBCParameter(byte[] bArr) {
        this.version = null;
        this.f5674iv = new DEROctetString(bArr);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f5674iv);
    ...
    private RC2CBCParameter(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 1) {
            this.version = null;
            this.f5674iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
            return;
        }
        this.version = (ASN1Integer) aSN1Sequence.getObjectAt(0);
        this.f5674iv = (ASN1OctetString) aSN1Sequence.getObjectAt(1);
    }
}
