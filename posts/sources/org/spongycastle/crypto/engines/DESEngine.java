...
public class DESEngine implements BlockCipher {
    ...
    private static final int[] bigbyte = {8388608, 4194304, PKIFailureInfo.badSenderNonce, 1048576, PKIFailureInfo.signerNotTrusted, 262144, PKIFailureInfo.unsupportedVersion, 65536, 32768, 16384, 8192, 4096, 2048, 1024, 512, 256, 128, 64, 32, 16, 8, 4, 2, 1};
    ...
    private static final int[] SP4 = {8396801, 8321, 8321, 128, 8396928, 8388737, 8388609, 8193, 0, 8396800, 8396800, 8396929, Wbxml.EXT_T_1, 0, 8388736, 8388609, 1, 8192, 8388608, 8396801, 128, 8388608, 8193, 8320, 8388737, 1, 8320, 8388736, 8192, 8396928, 8396929, Wbxml.EXT_T_1, 8388736, 8388609, 8396800, 8396929, Wbxml.EXT_T_1, 0, 0, 8396800, 8320, 8388736, 8388737, 1, 8396801, 8321, 8321, 128, 8396929, Wbxml.EXT_T_1, 1, 8192, 8388609, 8193, 8396928, 8388737, 8193, 8320, 8388608, 8396801, 128, 8388608, 8192, 8396928};
    ...
    public void desFunc(int[] iArr, byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i6 = i4 ^ i5;
        int i7 = i3 ^ (i5 << 4);
        int i8 = ((i7 >>> 16) ^ i6) & Settings.DEFAULT_INITIAL_WINDOW_SIZE;
        int i9 = i6 ^ i8;
        int i10 = i7 ^ (i8 << 16);
        ...
        int i45 = i42 ^ i44;
        int i46 = i43 ^ (i44 << 2);
        int i47 = ((i45 >>> 16) ^ i46) & Settings.DEFAULT_INITIAL_WINDOW_SIZE;
        int i48 = i46 ^ i47;
        int i49 = i45 ^ (i47 << 16);
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        throw new IllegalArgumentException(outline.m256o(cipherParameters, outline.m253r("invalid parameter passed to DES init - ")));
    }
