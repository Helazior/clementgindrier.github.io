...
public class SkipjackEngine implements BlockCipher {
    ...
    /* renamed from: g */
    private int m467g(int i, int i2) {
        int i3 = i2 & 255;
        short[] sArr = ftable;
    ...
    /* renamed from: h */
    private int m466h(int i, int i2) {
        int i3 = i2 & 255;
        int i4 = (i2 >> 8) & 255;
        short[] sArr = ftable;
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        throw new IllegalArgumentException(outline.m256o(cipherParameters, outline.m253r("invalid parameter passed to SKIPJACK init - ")));
    }
