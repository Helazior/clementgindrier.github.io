    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof KeyParameter) {
            ...
            if (this.forWrapping) {
                ...
                this.paramPlusIV = new ParametersWithIV(this.param, this.f5906iv);
            }
        } else if (cipherParameters instanceof ParametersWithIV) {
            ParametersWithIV parametersWithIV = (ParametersWithIV) cipherParameters;
            this.paramPlusIV = parametersWithIV;
            this.f5906iv = parametersWithIV.getIV();
            this.param = (KeyParameter) this.paramPlusIV.getParameters();
            if (this.forWrapping) {
                byte[] bArr2 = this.f5906iv;
    ...
    public byte[] unwrap(byte[] bArr, int i, int i2) {
        ...
        if (bArr != null) {
            ...
            if (i2 % blockSize == 0) {
                ...
                ParametersWithIV parametersWithIV = new ParametersWithIV(this.param, this.f5906iv);
                this.paramPlusIV = parametersWithIV;
            ...
            throw new InvalidCipherTextException(outline.m273H("Ciphertext not multiple of ", blockSize));
        }
    ...
    public byte[] wrap(byte[] bArr, int i, int i2) {
        if (this.forWrapping) {
            ...
            if (length % blockSize == 0) {
                ...
                byte[] bArr5 = this.f5906iv;
                byte[] bArr6 = new byte[bArr5.length + length];
                System.arraycopy(bArr5, 0, bArr6, 0, bArr5.length);
                System.arraycopy(bArr4, 0, bArr6, this.f5906iv.length, length);
