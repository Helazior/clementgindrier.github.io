...
public class IndexGenerator {
    ...
    public IndexGenerator(byte[] bArr, NTRUEncryptionParameters nTRUEncryptionParameters) {
        this.seed = bArr;
        this.f5917N = nTRUEncryptionParameters.f6030N;
        this.f5918c = nTRUEncryptionParameters.f6031c;
    ...
    public int nextIndex() {
        ...
        do {
            ...
            leadingAsInt = trailing.getLeadingAsInt(this.f5918c);
            i = this.f5918c;
            i2 = this.f5917N;
