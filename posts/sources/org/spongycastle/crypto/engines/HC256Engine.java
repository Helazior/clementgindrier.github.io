...
public class HC256Engine implements StreamCipher {
    ...
    /* renamed from: iv */
    private byte[] f5911iv;
    private byte[] key;

    /* renamed from: p */
    private int[] f5912p = new int[1024];

    /* renamed from: q */
    private int[] f5913q = new int[1024];
    private int cnt = 0;
    ...
    private void init() {
        ...
        if (this.f5911iv.length >= 16) {
            ...
            byte[] bArr4 = this.f5911iv;
            if (bArr4.length < 32) {
                byte[] bArr5 = new byte[32];
                System.arraycopy(bArr4, 0, bArr5, 0, bArr4.length);
                byte[] bArr6 = this.f5911iv;
            ...
            for (int i3 = 0; i3 < 32; i3++) {
                int i4 = (i3 >> 2) + 8;
                iArr[i4] = iArr[i4] | ((this.f5911iv[i3] & 255) << ((i3 & 3) * 8));
            }
            ...
            System.arraycopy(iArr, 512, this.f5912p, 0, 1024);
            System.arraycopy(iArr, 1536, this.f5913q, 0, 1024);
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f5911iv = parametersWithIV.getIV();
            cipherParameters2 = parametersWithIV.getParameters();
        } else {
            this.f5911iv = new byte[0];
        ...
        throw new IllegalArgumentException(outline.m256o(cipherParameters, outline.m253r("Invalid parameter passed to HC256 init - ")));
    }
}
