...
public class DSAParametersGenerator {
        ...
        while (true) {
            ...
            if (bigInteger.isProbablePrime(this.certainty)) {
                ...
                while (i7 < 4096) {
                    ...
                    if (subtract.bitLength() == this.f5951L && subtract.isProbablePrime(this.certainty)) {
    ...
    private DSAParameters generateParameters_FIPS186_3() {
        ...
        byte[] bArr = new byte[this.f5952N / 8];
        int i = this.f5951L;
        ...
        while (true) {
            ...
            BigInteger mod = bigInteger.mod(bigInteger2.shiftLeft(this.f5952N - i3));
            BigInteger subtract = bigInteger2.shiftLeft(this.f5952N - i3).add(mod).add(bigInteger2).subtract(mod.mod(TWO));
            if (subtract.isProbablePrime(this.certainty)) {
                byte[] clone = Arrays.clone(bArr);
                int i5 = this.f5951L * 4;
                int i6 = 0;
                while (i6 < i5) {
                    ...
                    BigInteger add = bigInteger3.add(bigInteger5.shiftLeft(this.f5951L - 1));
                    BigInteger subtract2 = add.subtract(add.mod(subtract.shiftLeft(1)).subtract(bigInteger5));
                    if (subtract2.bitLength() == this.f5951L && subtract2.isProbablePrime(this.certainty)) {
    ...
    public DSAParameters generateParameters() {
        return this.f5951L > 1024 ? generateParameters_FIPS186_3() : generateParameters_FIPS186_2();
    }
