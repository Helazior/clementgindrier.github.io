...
public class GOST3410ParametersGenerator {
    ...
    private int procedure_A(int i, int i2, BigInteger[] bigIntegerArr, int i3) {
        ...
        BigInteger bigInteger3 = new BigInteger(Integer.toString(i7));
        ...
        while (i13 < i10) {
            ...
            while (true) {
                ...
                while (i15 < i14) {
                    int i16 = i15 + 1;
                    bigIntegerArr2[i16] = bigIntegerArr2[i15].multiply(bigInteger4).add(bigInteger3).mod(TWO.pow(i11));
                    i15 = i16;
                }
                BigInteger bigInteger6 = new BigInteger(CrashlyticsReportDataCapture.SIGNAL_DEFAULT);
                for (int i17 = 0; i17 < i14; i17++) {
                    bigInteger6 = bigInteger6.add(bigIntegerArr2[i17].multiply(TWO.pow(i17 * 16)));
                }
                bigIntegerArr2[i8] = bigIntegerArr2[i14];
                BigInteger bigInteger7 = TWO;
                int i18 = i12 + 1;
                BigInteger add = bigInteger7.pow(iArr[i12] - 1).divide(bigIntegerArr4[i18]).add(bigInteger7.pow(iArr[i12] - 1).multiply(bigInteger6).divide(bigIntegerArr4[i18].multiply(bigInteger7.pow(i14 * 16))));
                ...
                while (true) {
                    ...
                    bigIntegerArr4[i12] = multiply.add(bigInteger9);
                    BigInteger bigInteger10 = bigIntegerArr4[i12];
                    BigInteger bigInteger11 = TWO;
                    i5 = i14;
                    if (bigInteger10.compareTo(bigInteger11.pow(iArr[i12])) == 1) {
                        break;
                    }
                    if (bigInteger11.modPow(bigIntegerArr4[i18].multiply(add.add(BigInteger.valueOf(j))), bigIntegerArr4[i12]).compareTo(bigInteger9) == 0 && bigInteger11.modPow(add.add(BigInteger.valueOf(j)), bigIntegerArr4[i12]).compareTo(bigInteger9) != 0) {
                        break;
                    }
                    i19 += 2;
                    i10 = i4;
    ...
    private long procedure_Aa(long j, long j2, BigInteger[] bigIntegerArr, int i) {
        ...
        while (i7 < i5) {
            ...
            while (true) {
                ...
                BigInteger bigInteger7 = TWO;
                int i13 = i6 + 1;
                BigInteger add = bigInteger7.pow(iArr[i6] - 1).divide(bigIntegerArr4[i13]).add(bigInteger7.pow(iArr[i6] - 1).multiply(bigInteger6).divide(bigIntegerArr4[i13].multiply(bigInteger7.pow(i9 * 32))));
                BigInteger mod = add.mod(bigInteger7);
                BigInteger bigInteger8 = ONE;
                if (mod.compareTo(bigInteger8) == 0) {
                    add = add.add(bigInteger8);
                ...
                while (true) {
                    ...
                    BigInteger bigInteger9 = ONE;
                    bigIntegerArr4[i6] = multiply.add(bigInteger9);
                    BigInteger bigInteger10 = bigIntegerArr4[i6];
                    bigInteger2 = bigInteger4;
                    BigInteger bigInteger11 = TWO;
                    i2 = i5;
                    ...
                    if (bigInteger11.modPow(bigIntegerArr4[i13].multiply(add.add(BigInteger.valueOf(j5))), bigIntegerArr4[i6]).compareTo(bigInteger9) == 0 && bigInteger11.modPow(add.add(BigInteger.valueOf(j5)), bigIntegerArr4[i6]).compareTo(bigInteger9) != 0) {
                        break;
                    }
                    i14 += 2;
                    bigInteger3 = bigInteger;
    ...
    private void procedure_B(int i, int i2, BigInteger[] bigIntegerArr) {
        ...
        while (true) {
            ...
            BigInteger bigInteger5 = new BigInteger(CrashlyticsReportDataCapture.SIGNAL_DEFAULT);
