...
public class OCSPUtil {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifier19 = CryptoProObjectIdentifiers.gostR3411_94_with_gostR3410_94;
        hashtable19.put("GOST3411WITHGOST3410", aSN1ObjectIdentifier19);
        algorithms.put("GOST3411WITHGOST3410-94", aSN1ObjectIdentifier19);
        ...
        oids.put(aSN1ObjectIdentifier19, "GOST3411WITHGOST3410");
    ...
    public static CertStore createCertStoreInstance(String str, CertStoreParameters certStoreParameters, String str2) {
        ...
        return CertStore.getInstance(str, certStoreParameters, str2);
    }
