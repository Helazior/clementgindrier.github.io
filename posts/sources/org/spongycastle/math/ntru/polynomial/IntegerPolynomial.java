...
public class IntegerPolynomial implements Polynomial {
        ...
        if (length <= 32) {
            ...
            for (int i3 = 0; i3 < i2; i3++) {
                for (int max = Math.max(0, (i3 - length) + 1); max <= Math.min(i3, length - 1); max++) {
                    ...
                    iArr3[i3] = (iArr2[max] * iArr[i3 - max]) + iArr3[i3];
                }
            }
    ...
    public Resultant resultant() {
        ...
        while (true) {
            bigInteger2 = it.hasNext() ? (BigInteger) it.next() : bigInteger2.nextProbablePrime();
            ModularResultant resultant = resultant(bigInteger2.intValue());
            ...
            mod = bigInteger3.multiply(calculate.f6159x.multiply(bigInteger2)).add(resultant.res.multiply(calculate.f6160y.multiply(bigInteger))).mod(multiply);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x008d, code lost:
        r10 = (org.spongycastle.math.ntru.polynomial.ModularResultant) r1.get();
     */
    /*
    ...
    */
    public org.spongycastle.math.ntru.polynomial.Resultant resultantMultiThread() {
        /*
            ...
            java.math.BigInteger r5 = org.spongycastle.math.ntru.polynomial.Constants.BIGINT_ONE
            java.util.concurrent.LinkedBlockingQueue r6 = new java.util.concurrent.LinkedBlockingQueue
            r6.<init>()
            java.util.List r7 = org.spongycastle.math.ntru.polynomial.IntegerPolynomial.BIGINT_PRIMES
        ...
        L64:
            org.spongycastle.math.ntru.polynomial.IntegerPolynomial$ModResultantTask r9 = new org.spongycastle.math.ntru.polynomial.IntegerPolynomial$ModResultantTask
            int r11 = r4.intValue()
            r9.<init>(r11)
        ...
        L79:
            ...
            r10 = r1
            org.spongycastle.math.ntru.polynomial.ModularResultant r10 = (org.spongycastle.math.ntru.polynomial.ModularResultant) r10     // Catch: java.lang.Exception -> Lae
            goto Lb9
        L95:
            org.spongycastle.math.ntru.polynomial.IntegerPolynomial$CombineTask r7 = new org.spongycastle.math.ntru.polynomial.IntegerPolynomial$CombineTask     // Catch: java.lang.Exception -> Lae
            java.lang.Object r1 = r1.get()     // Catch: java.lang.Exception -> Lae
            org.spongycastle.math.ntru.polynomial.ModularResultant r1 = (org.spongycastle.math.ntru.polynomial.ModularResultant) r1     // Catch: java.lang.Exception -> Lae
            java.lang.Object r4 = r4.get()     // Catch: java.lang.Exception -> Lae
            org.spongycastle.math.ntru.polynomial.ModularResultant r4 = (org.spongycastle.math.ntru.polynomial.ModularResultant) r4     // Catch: java.lang.Exception -> Lae
        ...
        Lb9:
            ...
            org.spongycastle.math.ntru.polynomial.BigIntPolynomial r4 = r10.rho
        ...
        L103:
            ...
            goto Le1
        L106:
            org.spongycastle.math.ntru.polynomial.Resultant r0 = new org.spongycastle.math.ntru.polynomial.Resultant
            r0.<init>(r4, r1)
            return r0
        */
    ...
    public ModularResultant resultant(int i) {
        ...
        while (degree > 0) {
            ...
            if (i5 < degree) {
                int pow = (Util.pow(integerPolynomial9.coeffs[degree], i3 - i5, i) * i4) % i;
                i4 = (i3 % 2 == 1 && degree % 2 == 1) ? (-pow) % i : pow;
                i3 = degree;
                degree = i5;
                i5 = i3;
        ...
        int pow2 = (Util.pow(integerPolynomial9.coeffs[0], i5, i) * i4) % i;
        integerPolynomial7.mult(Util.invert(integerPolynomial9.coeffs[0], i));
        integerPolynomial7.mod(i);
        integerPolynomial7.mult(pow2);
        integerPolynomial7.mod(i);
        int[] iArr3 = integerPolynomial7.coeffs;
        integerPolynomial7.coeffs = Arrays.copyOf(iArr3, iArr3.length - 1);
        return new ModularResultant(new BigIntPolynomial(integerPolynomial7), BigInteger.valueOf(pow2), BigInteger.valueOf(i));
    }
}
