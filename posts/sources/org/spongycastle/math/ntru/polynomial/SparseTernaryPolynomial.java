...
public class SparseTernaryPolynomial implements TernaryPolynomial {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && getClass() == obj.getClass()) {
            ...
            return this.f6166N == sparseTernaryPolynomial.f6166N && Arrays.areEqual(this.negOnes, sparseTernaryPolynomial.negOnes) && Arrays.areEqual(this.ones, sparseTernaryPolynomial.ones);
        }
        return false;
    }
    ...
    public int hashCode() {
        int hashCode = Arrays.hashCode(this.negOnes);
        return Arrays.hashCode(this.ones) + ((hashCode + ((this.f6166N + 31) * 31)) * 31);
    }
    ...
    public SparseTernaryPolynomial(int[] iArr) {
        ...
        int i = 0;
        int i2 = 0;
        for (int i3 = 0; i3 < this.f6166N; i3++) {
            int i4 = iArr[i3];
            if (i4 == -1) {
                this.negOnes[i2] = i3;
                i2++;
