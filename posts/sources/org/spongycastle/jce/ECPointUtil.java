...
public class ECPointUtil {
    public static ECPoint decodePoint(EllipticCurve ellipticCurve, byte[] bArr) {
        ...
        if (ellipticCurve.getField() instanceof ECFieldFp) {
            eCCurve = new ECCurve.C2160Fp(((ECFieldFp) ellipticCurve.getField()).getP(), ellipticCurve.getA(), ellipticCurve.getB());
        } else {
        ...
        org.spongycastle.math.p017ec.ECPoint decodePoint = eCCurve.decodePoint(bArr);
