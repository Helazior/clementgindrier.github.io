...
public class PKIXNameConstraintValidator {
    ...
    */
    ...
    private Set intersectIPRange(byte[] bArr, byte[] bArr2) {
        ...
        return Collections.singleton(ipWithSubnetMask(m460or(minMaxIPs[0], minMaxIPs[2]), m460or(bArr4, bArr6)));
    }
    ...
    /* renamed from: or */
    private static byte[] m460or(byte[] bArr, byte[] bArr2) {
    ...
    private String stringifyIP(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length / 2; i++) {
            ...
            m253r.append(Integer.toString(bArr[i] & 255));
            m253r.append(".");
            str = m253r.toString();
        }
        String m266e = outline.m266e(str.substring(0, str.length() - 1), "/");
        for (int length = bArr.length / 2; length < bArr.length; length++) {
            StringBuilder m253r2 = outline.m253r(m266e);
            m253r2.append(Integer.toString(bArr[length] & 255));
            m253r2.append(".");
            m266e = m253r2.toString();
        }
        return m266e.substring(0, m266e.length() - 1);
    }
    ...
    private String stringifyIPCollection(Set set) {
        ...
        String str = "[";
        while (it.hasNext()) {
            str = outline.m262i(outline.m253r(str), stringifyIP((byte[]) it.next()), ",");
        }
        if (str.length() > 1) {
            str = str.substring(0, str.length() - 1);
        }
        return outline.m266e(str, "]");
    }
    ...
    public String toString() {
        ...
        if (this.permittedSubtreesDN != null) {
            StringBuilder m253r = outline.m253r(outline.m266e("permitted:\n", "DN:\n"));
            m253r.append(this.permittedSubtreesDN.toString());
            m253r.append("\n");
            str = m253r.toString();
        }
        if (this.permittedSubtreesDNS != null) {
            StringBuilder m253r2 = outline.m253r(outline.m266e(str, "DNS:\n"));
            m253r2.append(this.permittedSubtreesDNS.toString());
            m253r2.append("\n");
            str = m253r2.toString();
        }
        if (this.permittedSubtreesEmail != null) {
            StringBuilder m253r3 = outline.m253r(outline.m266e(str, "Email:\n"));
            m253r3.append(this.permittedSubtreesEmail.toString());
            m253r3.append("\n");
            str = m253r3.toString();
        }
        if (this.permittedSubtreesURI != null) {
            StringBuilder m253r4 = outline.m253r(outline.m266e(str, "URI:\n"));
            m253r4.append(this.permittedSubtreesURI.toString());
            m253r4.append("\n");
            str = m253r4.toString();
        }
        if (this.permittedSubtreesIP != null) {
            str = outline.m262i(outline.m253r(outline.m266e(str, "IP:\n")), stringifyIPCollection(this.permittedSubtreesIP), "\n");
        }
        String m266e = outline.m266e(str, "excluded:\n");
        if (!this.excludedSubtreesDN.isEmpty()) {
            StringBuilder m253r5 = outline.m253r(outline.m266e(m266e, "DN:\n"));
            m253r5.append(this.excludedSubtreesDN.toString());
            m253r5.append("\n");
            m266e = m253r5.toString();
        }
        if (!this.excludedSubtreesDNS.isEmpty()) {
            StringBuilder m253r6 = outline.m253r(outline.m266e(m266e, "DNS:\n"));
            m253r6.append(this.excludedSubtreesDNS.toString());
            m253r6.append("\n");
            m266e = m253r6.toString();
        }
        if (!this.excludedSubtreesEmail.isEmpty()) {
            StringBuilder m253r7 = outline.m253r(outline.m266e(m266e, "Email:\n"));
            m253r7.append(this.excludedSubtreesEmail.toString());
            m253r7.append("\n");
            m266e = m253r7.toString();
        }
        if (!this.excludedSubtreesURI.isEmpty()) {
            StringBuilder m253r8 = outline.m253r(outline.m266e(m266e, "URI:\n"));
            m253r8.append(this.excludedSubtreesURI.toString());
            m253r8.append("\n");
            m266e = m253r8.toString();
        }
        return !this.excludedSubtreesIP.isEmpty() ? outline.m262i(outline.m253r(outline.m266e(m266e, "IP:\n")), stringifyIPCollection(this.excludedSubtreesIP), "\n") : m266e;
    }
