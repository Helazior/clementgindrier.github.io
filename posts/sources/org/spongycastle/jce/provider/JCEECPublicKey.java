...
public class JCEECPublicKey implements ECPublicKey, org.spongycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    /* renamed from: q */
    private ECPoint f6104q;
    private boolean withCompression;

    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = "EC";
        this.algorithm = str;
        this.f6104q = jCEECPublicKey.f6104q;
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (subjectPublicKeyInfo.getAlgorithmId().getObjectId().equals(CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                this.f6104q = curve2.createPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2), false);
        ...
        this.f6104q = new X9ECPoint(curve, dEROctetString).getPoint();
    }
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f6104q.getX().toBigInteger();
            BigInteger bigInteger2 = this.f6104q.getY().toBigInteger();
    ...
    public ECPoint getQ() {
        if (this.ecSpec == null) {
            if (this.f6104q instanceof ECPoint.C2162Fp) {
                return new ECPoint.C2162Fp(null, this.f6104q.getX(), this.f6104q.getY());
            }
            return new ECPoint.F2m(null, this.f6104q.getX(), this.f6104q.getY());
        }
        return this.f6104q;
    }
    ...
    public java.security.spec.ECPoint getW() {
        return new java.security.spec.ECPoint(this.f6104q.getX().toBigInteger(), this.f6104q.getY().toBigInteger());
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f6104q.getX().toBigInteger().toString(16));
        stringBuffer.append(property);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f6104q.getY().toBigInteger().toString(16));
        stringBuffer.append(property);
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f6104q = EC5Util.convertPoint(params, eCPublicKeySpec.getW(), false);
    }

    public JCEECPublicKey(String str, org.spongycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        this.algorithm = "EC";
        this.algorithm = str;
        this.f6104q = eCPublicKeySpec.getQ();
        ...
        if (this.f6104q.getCurve() == null) {
            this.f6104q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f6104q.getX().toBigInteger(), this.f6104q.getY().toBigInteger(), false);
        }
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters, ECParameterSpec eCParameterSpec) {
        ...
        this.algorithm = str;
        this.f6104q = eCPublicKeyParameters.getQ();
        if (eCParameterSpec == null) {
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f6104q = EC5Util.convertPoint(params, eCPublicKey.getW(), false);
    }
