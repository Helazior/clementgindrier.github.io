...
public class PEMUtil {
    ...
    public PEMUtil(String str) {
        this._header1 = outline.m265f("-----BEGIN ", str, "-----");
        this._header2 = outline.m265f("-----BEGIN X509 ", str, "-----");
        this._footer1 = outline.m265f("-----END ", str, "-----");
        this._footer2 = outline.m265f("-----END X509 ", str, "-----");
    }
