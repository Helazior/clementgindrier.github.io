...
public class JCEDHPublicKey implements DHPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f6102y;

    public JCEDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f6102y = dHPublicKeySpec.getY();
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        this.f6102y = (BigInteger) objectInputStream.readObject();
    ...
    public byte[] getEncoded() {
        ...
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, (ASN1Encodable) new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL())), new DERInteger(this.f6102y));
    }
    ...
    public JCEDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f6102y = ((DERInteger) subjectPublicKeyInfo.parsePublicKey()).getValue();
