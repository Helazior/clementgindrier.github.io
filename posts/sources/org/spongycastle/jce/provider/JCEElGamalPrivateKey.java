...
public class JCEElGamalPrivateKey implements ElGamalPrivateKey, DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    /* renamed from: x */
    public BigInteger f6105x;

    public JCEElGamalPrivateKey() {
    }

    private void readObject(ObjectInputStream objectInputStream) {
        this.f6105x = (BigInteger) objectInputStream.readObject();
    ...
    public byte[] getEncoded() {
        return KeyUtil.getEncodedPrivateKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, (ASN1Encodable) new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG())), new DERInteger(getX()));
    }
    ...
    public JCEElGamalPrivateKey(ElGamalPrivateKey elGamalPrivateKey) {
        this.f6105x = elGamalPrivateKey.getX();
        this.elSpec = elGamalPrivateKey.getParameters();
    }

    public JCEElGamalPrivateKey(DHPrivateKey dHPrivateKey) {
        this.f6105x = dHPrivateKey.getX();
    ...
    public JCEElGamalPrivateKey(ElGamalPrivateKeySpec elGamalPrivateKeySpec) {
        this.f6105x = elGamalPrivateKeySpec.getX();
    ...
    public JCEElGamalPrivateKey(DHPrivateKeySpec dHPrivateKeySpec) {
        this.f6105x = dHPrivateKeySpec.getX();
    ...
    public JCEElGamalPrivateKey(PrivateKeyInfo privateKeyInfo) {
        ...
        this.f6105x = DERInteger.getInstance(privateKeyInfo.parsePrivateKey()).getValue();
    ...
    public JCEElGamalPrivateKey(ElGamalPrivateKeyParameters elGamalPrivateKeyParameters) {
        this.f6105x = elGamalPrivateKeyParameters.getX();
