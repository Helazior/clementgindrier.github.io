...
public class LinearLayoutCompat extends ViewGroup {
    ...
    */
    public void layoutVertical(int r18, int r19, int r20, int r21) {
        ...
        L5a:
            ...
            r1 = r11
        L76:
            java.util.concurrent.atomic.AtomicInteger r2 = p000.C0492V4.f1798a
            int r2 = p000.C0492V4.C0496d.m1921d(r17)
    ...
    */
    ...
    public void setBaselineAlignedChildIndex(int i) {
        ...
        StringBuilder m253r = outline.m253r("base aligned child index out of range (0, ");
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        int[] iArr = C2012o.LinearLayoutCompat;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, iArr, i, 0);
        C0492V4.m1951t(this, context, iArr, attributeSet, obtainStyledAttributes, i, 0);
        int i2 = obtainStyledAttributes.getInt(C2012o.LinearLayoutCompat_android_orientation, -1);
        if (i2 >= 0) {
            setOrientation(i2);
        }
        int i3 = obtainStyledAttributes.getInt(C2012o.LinearLayoutCompat_android_gravity, -1);
        if (i3 >= 0) {
            setGravity(i3);
        }
        boolean z = obtainStyledAttributes.getBoolean(C2012o.LinearLayoutCompat_android_baselineAligned, true);
        if (!z) {
            setBaselineAligned(z);
        }
        this.mWeightSum = obtainStyledAttributes.getFloat(C2012o.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = obtainStyledAttributes.getInt(C2012o.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = obtainStyledAttributes.getBoolean(C2012o.LinearLayoutCompat_measureWithLargestChild, false);
        int i4 = C2012o.LinearLayoutCompat_divider;
        ...
        this.mShowDividers = obtainStyledAttributes.getInt(C2012o.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = obtainStyledAttributes.getDimensionPixelSize(C2012o.LinearLayoutCompat_dividerPadding, 0);
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.f2510b = -1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2012o.LinearLayoutCompat_Layout);
            this.f2509a = obtainStyledAttributes.getFloat(C2012o.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.f2510b = obtainStyledAttributes.getInt(C2012o.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            obtainStyledAttributes.recycle();
        }
