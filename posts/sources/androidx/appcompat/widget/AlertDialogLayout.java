...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: d */
    public static int m1637d(View view) {
        AtomicInteger atomicInteger = C0492V4.f1798a;
        int m1940d = C0492V4.C0495c.m1940d(view);
        if (m1940d > 0) {
            return m1940d;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m1637d(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    */
    public void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L73:
            ...
            int r8 = p000.C0492V4.C0496d.m1921d(r9)
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C1930k.topPanel) {
                    view = childAt;
                } else if (id != C1930k.buttonPanel) {
                    if ((id != C1930k.contentPanel && id != C1930k.customPanel) || view3 != null) {
                        break;
                    }
                    view3 = childAt;
                } else {
